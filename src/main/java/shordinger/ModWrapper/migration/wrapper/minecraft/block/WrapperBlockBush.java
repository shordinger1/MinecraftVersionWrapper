...
public class WrapperBlockBush extends WrapperBlock implements net.minecraftforge.common.IPlantable {
    ...
    protected WrapperBlockBush() {
        this(Material.PLANTS);
    }

    protected WrapperBlockBush(Material materialIn) {
        this(materialIn, materialIn.getMaterialMapColor());
    }

    protected WrapperBlockBush(Material materialIn, MapColor mapColorIn) {
