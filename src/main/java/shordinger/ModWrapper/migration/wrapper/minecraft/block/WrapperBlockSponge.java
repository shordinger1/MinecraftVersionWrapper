...
public class WrapperBlockSponge extends WrapperBlock {

    public static final PropertyBool WET = PropertyBool.create("wet");

    protected WrapperBlockSponge() {
    ...
    protected void tryAbsorb(World worldIn, BlockPos pos, IWrapperBlockState state) {
        if (!((Boolean) state.getValue(WET)).booleanValue() && this.absorb(worldIn, pos)) {
            ...
            worldIn.playEvent(2001, pos, WrapperBlock.getIdFromBlock(Blocks.WATER));
        }
    }
