...
public abstract class WrapperBlockStateBase implements IWrapperBlockState {
     ...
     */
    public <T extends Comparable<T>> IWrapperBlockState cycleProperty(IProperty<T> property) {
    ...
    @Nullable
    public com.google.common.collect.ImmutableTable<IProperty<?>, Comparable<?>, IWrapperBlockState> getPropertyValueTable() {
        return null;
    }
}
