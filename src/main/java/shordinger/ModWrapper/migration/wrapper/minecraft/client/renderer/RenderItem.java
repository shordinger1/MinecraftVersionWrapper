...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    private void renderModel(IBakedModel model, int color, ItemStack stack) {
        ...
        for (EnumFacing enumfacing : EnumFacing.values()) {
            this.renderQuads(bufferbuilder, model.getQuads((IWrapperBlockState) null, enumfacing, 0L), color, stack);
        }

        this.renderQuads(bufferbuilder, model.getQuads((IWrapperBlockState) null, (EnumFacing) null, 0L), color, stack);
        tessellator.draw();
    }
