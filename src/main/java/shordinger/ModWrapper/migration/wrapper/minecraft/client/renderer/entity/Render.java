...
public abstract class Render<T extends Entity> {
    ...
    private void renderShadow(Entity entityIn, double x, double y, double z, float shadowAlpha, float partialTicks) {
        ...
        for (BlockPos blockpos : BlockPos.getAllInBoxMutable(new BlockPos(i, k, i1), new BlockPos(j, l, j1))) {
            IWrapperBlockState iblockstate = world.getBlockState(blockpos.down());
    ...
    private void renderShadowSingle(IWrapperBlockState state, double p_188299_2_, double p_188299_4_,
        double p_188299_6_, BlockPos p_188299_8_, float p_188299_9_, float p_188299_10_, double p_188299_11_,
