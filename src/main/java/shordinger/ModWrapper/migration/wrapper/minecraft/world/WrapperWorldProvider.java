...
public abstract class WrapperWorldProvider extends WorldProvider {
    ...
    public WrapperWorldType terrainType;
    ...
    public double getMovementFactor() {
        if (this instanceof WrapperWorldProviderHell) {
            return 8.0;
        }
        return 1.0;
    }
    ...
    public boolean shouldClientCheckLighting() {
        return !(this instanceof WrapperWorldProviderSurface);
    }
