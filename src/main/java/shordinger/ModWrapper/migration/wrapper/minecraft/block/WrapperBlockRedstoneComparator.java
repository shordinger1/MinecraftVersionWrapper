...
public class WrapperBlockRedstoneComparator extends WrapperBlockRedstoneDiode implements ITileEntityProvider {

    public static final PropertyBool POWERED = PropertyBool.create("powered");
    public static final PropertyEnum<WrapperBlockRedstoneComparator.Mode> MODE = PropertyEnum.<WrapperBlockRedstoneComparator.Mode>create(
        "mode",
        WrapperBlockRedstoneComparator.Mode.class);

    public WrapperBlockRedstoneComparator(boolean powered) {
        super(powered);
        this.setDefaultState(
            this.blockState.getBaseState()
                .withProperty(FACING, EnumFacing.NORTH)
                .withProperty(POWERED, Boolean.valueOf(false))
                .withProperty(MODE, WrapperBlockRedstoneComparator.Mode.COMPARE));
    ...
    protected IWrapperBlockState getPoweredState(IWrapperBlockState unpoweredState) {
        ...
        WrapperBlockRedstoneComparator.Mode blockredstonecomparator$mode = (WrapperBlockRedstoneComparator.Mode) unpoweredState
            .getValue(MODE);
    ...
    protected IWrapperBlockState getUnpoweredState(IWrapperBlockState poweredState) {
        ...
        WrapperBlockRedstoneComparator.Mode blockredstonecomparator$mode = (WrapperBlockRedstoneComparator.Mode) poweredState
            .getValue(MODE);
    ...
    private int calculateOutput(World worldIn, BlockPos pos, IWrapperBlockState state) {
        return state.getValue(MODE) == WrapperBlockRedstoneComparator.Mode.SUBTRACT
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IWrapperBlockState state, EntityPlayer playerIn,
        ...
        if (!playerIn.capabilities.allowEdit) {
            ...
            float f = state.getValue(MODE) == WrapperBlockRedstoneComparator.Mode.SUBTRACT ? 0.55F : 0.5F;
    ...
    private void onStateChange(World worldIn, BlockPos pos, IWrapperBlockState state) {
        int i = this.calculateOutput(worldIn, pos, state);
        TileEntity tileentity = worldIn.getTileEntity(pos);
        int j = 0;
        ...
        if (j != i || state.getValue(MODE) == WrapperBlockRedstoneComparator.Mode.COMPARE) {
    ...
    public IWrapperBlockState getStateFromMeta(int meta) {
        return this.getDefaultState()
            ...
            .withProperty(
                MODE,
                (meta & 4) > 0 ? WrapperBlockRedstoneComparator.Mode.SUBTRACT
                    : WrapperBlockRedstoneComparator.Mode.COMPARE);
    }
    ...
    public int getMetaFromState(IWrapperBlockState state) {
        ...
        if (state.getValue(MODE) == WrapperBlockRedstoneComparator.Mode.SUBTRACT) {
            i |= 4;
        }
