...
public class WrapperBlockRedstoneWire extends WrapperBlock {

    public static final PropertyEnum<WrapperBlockRedstoneWire.EnumAttachPosition> NORTH = PropertyEnum.<WrapperBlockRedstoneWire.EnumAttachPosition>create(
        "north",
        WrapperBlockRedstoneWire.EnumAttachPosition.class);
    public static final PropertyEnum<WrapperBlockRedstoneWire.EnumAttachPosition> EAST = PropertyEnum.<WrapperBlockRedstoneWire.EnumAttachPosition>create(
        "east",
        WrapperBlockRedstoneWire.EnumAttachPosition.class);
    public static final PropertyEnum<WrapperBlockRedstoneWire.EnumAttachPosition> SOUTH = PropertyEnum.<WrapperBlockRedstoneWire.EnumAttachPosition>create(
        "south",
        WrapperBlockRedstoneWire.EnumAttachPosition.class);
    public static final PropertyEnum<WrapperBlockRedstoneWire.EnumAttachPosition> WEST = PropertyEnum.<WrapperBlockRedstoneWire.EnumAttachPosition>create(
        "west",
        WrapperBlockRedstoneWire.EnumAttachPosition.class);
    ...
    public WrapperBlockRedstoneWire() {
        super(Material.CIRCUITS);
        this.setDefaultState(
            this.blockState.getBaseState()
                .withProperty(NORTH, WrapperBlockRedstoneWire.EnumAttachPosition.NONE)
                .withProperty(EAST, WrapperBlockRedstoneWire.EnumAttachPosition.NONE)
                .withProperty(SOUTH, WrapperBlockRedstoneWire.EnumAttachPosition.NONE)
                .withProperty(WEST, WrapperBlockRedstoneWire.EnumAttachPosition.NONE)
    ...
    private static int getAABBIndex(IWrapperBlockState state) {
        int i = 0;
        boolean flag = state.getValue(NORTH) != WrapperBlockRedstoneWire.EnumAttachPosition.NONE;
        boolean flag1 = state.getValue(EAST) != WrapperBlockRedstoneWire.EnumAttachPosition.NONE;
        boolean flag2 = state.getValue(SOUTH) != WrapperBlockRedstoneWire.EnumAttachPosition.NONE;
        boolean flag3 = state.getValue(WEST) != WrapperBlockRedstoneWire.EnumAttachPosition.NONE;
    ...
    private WrapperBlockRedstoneWire.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos,
        EnumFacing direction) {
        BlockPos blockpos = pos.offset(direction);
        IWrapperBlockState iblockstate = worldIn.getBlockState(pos.offset(direction));
        ...
        if (!canConnectTo(worldIn.getBlockState(blockpos), direction, worldIn, blockpos)
            ...
            IWrapperBlockState iblockstate1 = worldIn.getBlockState(pos.up());
            ...
            if (!iblockstate1.isNormalCube()) {
                ...
                if (flag && canConnectUpwardsTo(worldIn, blockpos.up())) {
                    if (iblockstate.isBlockNormalCube()) {
                        return WrapperBlockRedstoneWire.EnumAttachPosition.UP;
                    }

                    return WrapperBlockRedstoneWire.EnumAttachPosition.SIDE;
                }
            }

            return WrapperBlockRedstoneWire.EnumAttachPosition.NONE;
        } else {
            return WrapperBlockRedstoneWire.EnumAttachPosition.SIDE;
        }
    }
    ...
    private IWrapperBlockState updateSurroundingRedstone(World worldIn, BlockPos pos, IWrapperBlockState state) {
    ...
    private IWrapperBlockState calculateCurrentChanges(World worldIn, BlockPos pos1, BlockPos pos2,
        IWrapperBlockState state) {
        IWrapperBlockState iblockstate = state;
    ...
    private boolean isPowerSourceAt(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        ...
        if (!flag1 && flag && canConnectUpwardsTo(worldIn, blockpos.up())) {
            ...
            && iblockstate.getValue(WrapperBlockRedstoneDiode.FACING) == side) {
                return true;
            } else {
    ...
    protected static boolean canConnectTo(IWrapperBlockState blockState, @Nullable EnumFacing side, IBlockAccess world,
        BlockPos pos) {
        WrapperBlock wrapperBlock = blockState.getBlock();

        if (wrapperBlock == Blocks.REDSTONE_WIRE) {
            return true;
        } else if (Blocks.UNPOWERED_REPEATER.isSameDiode(blockState)) {
            EnumFacing enumfacing = (EnumFacing) blockState.getValue(WrapperBlockRedstoneRepeater.FACING);
            return enumfacing == side || enumfacing.getOpposite() == side;
        } else if (Blocks.OBSERVER == blockState.getBlock()) {
            return side == blockState.getValue(WrapperBlockObserver.FACING);
        } else {
