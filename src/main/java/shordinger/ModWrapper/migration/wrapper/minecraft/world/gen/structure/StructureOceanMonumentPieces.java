...
public class StructureOceanMonumentPieces {
    ...
    public static class DoubleXYRoom extends StructureOceanMonumentPieces.Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i = 1; i <= 7; ++i) {
                IWrapperBlockState iblockstate = BRICKS_PRISMARINE;
    ...
    public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int j = 1; j <= 7; ++j) {
                IWrapperBlockState iblockstate1 = DARK_PRISMARINE;
    ...
    public abstract static class Piece extends StructureComponent {
        ...
        protected static final IWrapperBlockState ROUGH_PRISMARINE = Blocks.PRISMARINE
            .getStateFromMeta(BlockPrismarine.ROUGH_META);
        protected static final IWrapperBlockState BRICKS_PRISMARINE = Blocks.PRISMARINE
            .getStateFromMeta(BlockPrismarine.BRICKS_META);
        protected static final IWrapperBlockState DARK_PRISMARINE = Blocks.PRISMARINE
            .getStateFromMeta(BlockPrismarine.DARK_META);
        protected static final IWrapperBlockState DOT_DECO_DATA = BRICKS_PRISMARINE;
        protected static final IWrapperBlockState SEA_LANTERN = Blocks.SEA_LANTERN.getDefaultState();
        protected static final IWrapperBlockState WATER = Blocks.WATER.getDefaultState();
        ...
        protected void generateBoxOnFillOnly(World worldIn, StructureBoundingBox p_175819_2_, int p_175819_3_,
            ...
            IWrapperBlockState p_175819_9_) {
