package shordinger.ModWrapper.migration.wrapper.minecraft.entity.player;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public float getDigSpeed(IWrapperBlockState state) {
        return getDigSpeed(state, null);
    }

    public float getDigSpeed(IWrapperBlockState state, BlockPos pos) {
    ...
    public boolean canHarvestBlock(IWrapperBlockState state) {
    ...
    public EntityPlayer.SleepResult trySleep(BlockPos bedLocation) {
        ...
        final IWrapperBlockState state = this.world.isBlockLoaded(bedLocation) ? this.world.getBlockState(bedLocation)
            : null;
    ...
    public void wakeUpPlayer(boolean immediately, boolean updateWorldFlag, boolean setSpawn) {
        ...
        this.setSize(0.6F, 1.8F);
        IWrapperBlockState iblockstate = this.bedLocation == null ? null : this.world.getBlockState(this.bedLocation);
    ...
    public static BlockPos getBedSpawnLocation(World worldIn, BlockPos bedLocation, boolean forceSpawn) {
        IWrapperBlockState state = worldIn.getBlockState(bedLocation);
    ...
    public float getBedOrientationInDegrees() {
        IWrapperBlockState state = this.bedLocation == null ? null : this.world.getBlockState(bedLocation);
