...
public class WrapperItemShears extends WrapperItem {

    public WrapperItemShears() {
     ...
     */
    @Override
    public boolean itemInteractionForEntity(TempItemStack itemstack, net.minecraft.entity.player.EntityPlayer player,
        ...
        if (entity instanceof net.minecraftforge.common.IShearable) {
            ...
            if (target.isShearable(itemstack, entity.world, pos)) {
                java.util.List<TempItemStack> drops = target.onSheared(
                    itemstack,
                    entity.world,
                    pos,
    ...
    @Override
    public boolean onBlockStartBreak(TempItemStack itemstack, BlockPos pos,
