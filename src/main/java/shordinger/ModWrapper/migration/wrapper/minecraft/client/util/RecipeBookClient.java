package shordinger.ModWrapper.migration.wrapper.minecraft.client.util;
...
public class RecipeBookClient extends RecipeBook {
    ...
    private static RecipeList newRecipeList(CreativeTabs p_194082_0_) {
        ...
        (RECIPES_BY_TAB.computeIfAbsent(p_194082_0_, (p_194085_0_) -> { return new ArrayList(); })).add(recipelist);
        (RECIPES_BY_TAB.computeIfAbsent(CreativeTabs.SEARCH, (p_194083_0_) -> { return new ArrayList(); }))
            .add(recipelist);
        return recipelist;
    }
