package shordinger.ModWrapper.migration.wrapper.minecraft.server.management;
...
public class PlayerInteractionManager {
    ...
    public void updateBlockRemoving() {
        ...
        if (this.receivedFinishDiggingPacket) {
            ...
            IWrapperBlockState iblockstate = this.world.getBlockState(this.delayedDestroyPos);
            ...
            IWrapperBlockState iblockstate1 = this.world.getBlockState(this.destroyPos);
