package shordinger.ModWrapper.migration.wrapper.minecraft.creativetab;
...
public abstract class CreativeTabs {
    ...
    public static final CreativeTabs COMBAT = (new CreativeTabs(9, "combat") {
        ...
        new EnumEnchantmentType[] { EnumEnchantmentType.ALL, EnumEnchantmentType.ARMOR, EnumEnchantmentType.ARMOR_FEET,
            EnumEnchantmentType.ARMOR_HEAD, EnumEnchantmentType.ARMOR_LEGS, EnumEnchantmentType.ARMOR_CHEST,
            EnumEnchantmentType.BOW, EnumEnchantmentType.WEAPON, EnumEnchantmentType.WEARABLE,
