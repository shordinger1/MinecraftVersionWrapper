...
public class WrapperBlockEndRod extends WrapperBlockDirectional {
    ...
    public IWrapperBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX,
        ...
        IWrapperBlockState iblockstate = worldIn.getBlockState(pos.offset(facing.getOpposite()));
