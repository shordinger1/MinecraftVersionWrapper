...
public class WrapperItemElytra extends WrapperItem {

    public WrapperItemElytra() {
        this.maxStackSize = 1;
        ...
        this.addPropertyOverride(new ResourceLocation("broken"), new IItemPropertyGetter() {
            ...
            public float apply(TempItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                return WrapperItemElytra.isUsable(stack) ? 0.0F : 1.0F;
            }
        });
        BlockDispenser.DISPENSE_BEHAVIOR_REGISTRY.putObject(this, WrapperItemArmor.DISPENSER_BEHAVIOR);
    }

    public static boolean isUsable(TempItemStack stack) {
