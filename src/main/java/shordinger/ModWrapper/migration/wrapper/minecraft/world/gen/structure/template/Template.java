...
public class Template {
    ...
    public void takeBlocksFromWorld(World worldIn, BlockPos startPos, BlockPos size, boolean takeEntities,
        ...
        if (size.getX() >= 1 && size.getY() >= 1 && size.getZ() >= 1) {
            ...
            for (BlockPos.MutableBlockPos blockpos$mutableblockpos : BlockPos
                ...
                IWrapperBlockState iblockstate = worldIn.getBlockState(blockpos$mutableblockpos);
    ...
    public Map<BlockPos, String> getDataBlocks(BlockPos pos, PlacementSettings placementIn) {
        ...
        for (Template.BlockInfo template$blockinfo : this.blocks) {
            ...
            if (structureboundingbox == null || structureboundingbox.isVecInside(blockpos)) {
                IWrapperBlockState iblockstate = template$blockinfo.blockState;
     ...
     * @param pos         The origin position for the structure
     * @param placementIn Placement settings to use
     * @param flags       Flags to pass to {@link World#setBlockState(BlockPos, IWrapperBlockState, int)}
     */
            ...
            for (Template.BlockInfo template$blockinfo : this.blocks) {
                ...
                if (template$blockinfo1 != null) {
                    ...
                    if ((block == null || block != block1)
                        ...
                        IWrapperBlockState iblockstate = template$blockinfo1.blockState
                            .withMirror(placementIn.getMirror());
                        IWrapperBlockState iblockstate1 = iblockstate.withRotation(placementIn.getRotation());
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbt) {
        ...
        for (IWrapperBlockState iblockstate : template$basicpalette) {
    ...
    public void read(NBTTagCompound compound) {
        ...
        for (int j = 0; j < nbttaglist3.tagCount(); ++j) {
            ...
            IWrapperBlockState iblockstate = template$basicpalette.stateFor(nbttagcompound.getInteger("state"));
    ...
    static class BasicPalette implements Iterable<IWrapperBlockState> {

        public static final IWrapperBlockState DEFAULT_BLOCK_STATE = Blocks.AIR.getDefaultState();
        final ObjectIntIdentityMap<IWrapperBlockState> ids;
        private int lastId;

        private BasicPalette() {
            this.ids = new ObjectIntIdentityMap<IWrapperBlockState>(16);
        }
        ...
        @Nullable
        public IWrapperBlockState stateFor(int id) {
            IWrapperBlockState iblockstate = this.ids.getByValue(id);
            return iblockstate == null ? DEFAULT_BLOCK_STATE : iblockstate;
        }

        public Iterator<IWrapperBlockState> iterator() {
            return this.ids.iterator();
        }

        public void addMapping(IWrapperBlockState p_189956_1_, int p_189956_2_) {
    ...
    public static class BlockInfo {
        ...
        public final IWrapperBlockState blockState;
        /** NBT data for the tileentity */
        public final NBTTagCompound tileentityData;

        public BlockInfo(BlockPos posIn, IWrapperBlockState stateIn, @Nullable NBTTagCompound compoundIn) {
            this.pos = posIn;
