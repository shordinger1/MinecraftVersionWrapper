...
public class WrapperItemChorusFruit extends WrapperItemFood {

    public WrapperItemChorusFruit(int amount, float saturation) {
    ...
    public TempItemStack onItemUseFinish(TempItemStack stack, World worldIn, EntityLivingBase entityLiving) {
        TempItemStack itemstack = super.onItemUseFinish(stack, worldIn, entityLiving);
