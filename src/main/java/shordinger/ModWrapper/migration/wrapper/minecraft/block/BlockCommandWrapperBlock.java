...
public class BlockCommandWrapperBlock extends WrapperBlockContainer {

    private static final Logger LOGGER = LogManager.getLogger();
    public static final PropertyDirection FACING = WrapperBlockDirectional.FACING;
    public static final PropertyBool CONDITIONAL = PropertyBool.create("conditional");

    public BlockCommandWrapperBlock(MapColor color) {
    ...
    private void execute(IWrapperBlockState p_193387_1_, World p_193387_2_, BlockPos p_193387_3_,
    ...
    private static void executeChain(World p_193386_0_, BlockPos p_193386_1_, EnumFacing p_193386_2_) {
        ...
        for (i = gamerules.getInt("maxCommandChainLength"); i--
            ...
            if (wrapperBlock != Blocks.CHAIN_COMMAND_BLOCK) {
                break;
            }
            ...
            if (tileentitycommandblock.isPowered() || tileentitycommandblock.isAuto()) {
                ...
                if (tileentitycommandblock.setConditionMet()) {
                    ...
                    p_193386_0_.updateComparatorOutputLevel(blockpos$mutableblockpos, wrapperBlock);
                } else if (tileentitycommandblock.isConditional()) {
                    commandblockbaselogic.setSuccessCount(0);
                }
            }
