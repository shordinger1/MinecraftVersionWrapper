...
public class TileEntityPiston extends TileEntity implements ITickable {
    ...
    private IWrapperBlockState pistonState;
    ...
    public TileEntityPiston(IWrapperBlockState pistonStateIn, EnumFacing pistonFacingIn, boolean extendingIn,
    ...
    public IWrapperBlockState getPistonState() {
    ...
    public AxisAlignedBB getAABB(IBlockAccess p_184319_1_, BlockPos p_184319_2_, float p_184319_3_) {
        ...
        IWrapperBlockState iblockstate = this.getCollisionRelatedBlockState();
    ...
    private IWrapperBlockState getCollisionRelatedBlockState() {
