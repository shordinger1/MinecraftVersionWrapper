...
public abstract class TileEntity
    ...
    public int getBlockMetadata() {
        if (this.blockMetadata == -1) {
            IWrapperBlockState iblockstate = this.world.getBlockState(this.pos);
    ...
    public void addInfoToCrashReport(CrashReportCategory reportCategory) {
        ...
        if (this.world != null) {
            ...
            reportCategory.addDetail("Actual block data value", new ICrashReportDetail<String>() {
                ...
                public String call() throws Exception {
                    IWrapperBlockState iblockstate = TileEntity.this.world.getBlockState(TileEntity.this.pos);
     ...
     */
    public boolean shouldRefresh(World world, BlockPos pos, IWrapperBlockState oldState, IWrapperBlockState newSate) {
