...
import shordinger.ModWrapper.migration.wrapper.minecraft.entity.player.EntityPlayer;
...
public class WrapperItemArmorStand extends WrapperItem {

    public WrapperItemArmorStand() {
                ...
                if (flag1) {
                    ...
                    if (!list.isEmpty()) {
                        ...
                        if (!worldIn.isRemote) {
                            ...
                            WrapperItemMonsterPlacer.applyItemEntityDataToEntity(worldIn, player, itemstack, entityarmorstand);
