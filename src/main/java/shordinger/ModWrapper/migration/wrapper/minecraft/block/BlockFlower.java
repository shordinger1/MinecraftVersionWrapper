...
public abstract class BlockFlower extends BlockBush {
    ...
    public static enum EnumFlowerType implements IStringSerializable {
         ...
         */
        public static BlockFlower.EnumFlowerType getType(BlockFlower.EnumFlowerColor blockType,
                                                         int meta) {
        ...
        static {
            for (final BlockFlower.EnumFlowerColor blockflower$enumflowercolor : BlockFlower.EnumFlowerColor
                .values()) {
                ...
                TYPES_FOR_BLOCK[blockflower$enumflowercolor
                    .ordinal()] = (BlockFlower.EnumFlowerType[]) collection
