...
public class WrapperItemFirework extends WrapperItem {
    ...
    public ActionResult<TempItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        if (playerIn.isElytraFlying()) {
            ...
            return new ActionResult<TempItemStack>(EnumActionResult.PASS, playerIn.getHeldItem(handIn));
        }
    }
        ...
        if (nbttagcompound != null) {
            ...
            if (!nbttaglist.hasNoTags()) {
                for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                    ...
                    WrapperItemFireworkCharge.addExplosionInfo(nbttagcompound1, list);
