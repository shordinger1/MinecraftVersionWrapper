package shordinger.ModWrapper.migration.wrapper.minecraft.client.multiplayer;
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face) {
        ...
        if (!this.mc.world.getWorldBorder()
            ...
            if (this.currentGameType.isCreative()) {
                ...
                IWrapperBlockState iblockstate = this.mc.world.getBlockState(loc);
                this.mc.getTutorial()
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
        ...
        if (this.blockHitDelay > 0) {
            ...
            .contains(posBlock)) {
                ...
                IWrapperBlockState iblockstate = this.mc.world.getBlockState(posBlock);
                Block block = iblockstate.getBlock();
