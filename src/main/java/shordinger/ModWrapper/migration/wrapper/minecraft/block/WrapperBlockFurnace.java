...
public class WrapperBlockFurnace extends WrapperBlockContainer {

    public static final PropertyDirection FACING = WrapperBlockHorizontal.FACING;
    private final boolean isBurning;
    private static boolean keepInventory;

    protected WrapperBlockFurnace(boolean isBurning) {
        super(Material.ROCK);
    ...
    private void setDefaultFacing(World worldIn, BlockPos pos, IWrapperBlockState state) {
        if (!worldIn.isRemote) {
