...
public abstract class WrapperBlockButton extends WrapperBlockDirectional {
    ...
    protected WrapperBlockButton(boolean wooden) {
    ...
    protected static boolean canPlaceBlock(World worldIn, BlockPos pos, EnumFacing direction) {
        ...
        if (direction == EnumFacing.UP) {
            return iblockstate.isTopSolid() || !isExceptionBlockForAttaching(wrapperBlock) && flag;
        } else {
            return !isExceptBlockForAttachWithPiston(wrapperBlock) && flag;
        }
    }
    ...
    private void checkPressed(IWrapperBlockState state, World worldIn, BlockPos pos) {
