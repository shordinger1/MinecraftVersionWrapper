...
public class WrapperBlockCauldron extends WrapperBlock {
    ...
    public void setWaterLevel(World worldIn, BlockPos pos, IWrapperBlockState state, int level) {
