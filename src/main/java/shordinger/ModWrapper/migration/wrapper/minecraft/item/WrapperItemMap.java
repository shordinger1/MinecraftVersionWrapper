...
public class WrapperItemMap extends WrapperItemMapBase {

    protected WrapperItemMap() {
        this.setHasSubtypes(true);
    }

    public static TempItemStack setupNewMap(World worldIn, double worldX, double worldZ, byte scale,
                                            boolean trackingPosition, boolean unlimitedTracking) {
        TempItemStack itemstack = new TempItemStack(Items.FILLED_MAP, 1, worldIn.getUniqueDataId("map"));
    ...
    @Nullable
    public MapData getMapData(TempItemStack stack, World worldIn) {
                                ...
                                if (worldIn.provider.isNether()) {
                                    ...
                                    for (int i4 = 0; i4 < i; ++i4) {
                                        for (int j4 = 0; j4 < i; ++j4) {
                                            ...
                                            IWrapperBlockState iblockstate = Blocks.AIR.getDefaultState();
                                            ...
                                            if (k4 <= 1) {
                                                ...
                                                label175: {
                                                    ...
                                                    if (k4 > 0 && iblockstate.getMaterial()
                                                        ...
                                                        while (true) {
                                                            IWrapperBlockState iblockstate1 = chunk
     ...
     */
    public static void renderBiomePreviewMap(World worldIn, TempItemStack map) {
        if (map.getItem() instanceof WrapperItemMap) {
            MapData mapdata = ((WrapperItemMap) map.getItem()).getMapData(map, worldIn);
     ...
     */
    public void onUpdate(TempItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        if (!worldIn.isRemote) {
     ...
     */
    public void onCreated(TempItemStack stack, World worldIn, EntityPlayer playerIn) {
    ...
    protected static void scaleMap(TempItemStack p_185063_0_, World p_185063_1_, int p_185063_2_) {
    ...
    protected static void enableMapTracking(TempItemStack p_185064_0_, World p_185064_1_) {
    ...
    @SideOnly(Side.CLIENT)
    public static int getColor(TempItemStack p_190907_0_) {
