...
public class WorldProviderEnd extends WorldProvider {
    ...
    public void init() {
        ...
        NBTTagCompound nbttagcompound = this.wrapperWorld.getWorldInfo()
            .getDimensionData(this.wrapperWorld.provider.getDimension());
        this.dragonFightManager = this.wrapperWorld instanceof WrapperWorldServer
            ? new DragonFightManager(
                (WrapperWorldServer) this.wrapperWorld,
                nbttagcompound.getCompoundTag("DragonFight"))
            : null;
    }
    ...
    public IChunkGenerator createChunkGenerator() {
        return new ChunkGeneratorEnd(
            this.wrapperWorld,
            this.wrapperWorld.getWorldInfo()
                .isMapFeaturesEnabled(),
            this.wrapperWorld.getSeed(),
    ...
    public boolean canCoordinateBeSpawn(int x, int z) {
        return this.wrapperWorld.getGroundAboveSeaLevel(new BlockPos(x, 0, z))
            .getMaterial()
            .blocksMovement();
    }
    ...
    public void onWorldSave() {
        ...
        this.wrapperWorld.getWorldInfo()
            .setDimensionData(this.wrapperWorld.provider.getDimension(), nbttagcompound);
    }
