...
public class WrapperBlockPortal extends WrapperBlockBreakable {
    ...
    public boolean trySpawnPortal(World worldIn, BlockPos pos) {
        WrapperBlockPortal.Size blockportal$size = new WrapperBlockPortal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        if (blockportal$size.isValid() && blockportal$size.portalBlockCount == 0
            ...
            WrapperBlockPortal.Size blockportal$size1 = new WrapperBlockPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public BlockPattern.PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_) {
        ...
        WrapperBlockPortal.Size blockportal$size = new WrapperBlockPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(worldIn, true);

        if (!blockportal$size.isValid()) {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new WrapperBlockPortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.Z);
        }
    ...
    public static class Size {
        ...
        protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
            ...
            WrapperBlock wrapperBlock = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i))
                .getBlock();
            return wrapperBlock == Blocks.OBSIDIAN ? i : 0;
        }
            ...
            for (this.height = 0; this.height < 21; ++this.height) {
                for (int i = 0; i < this.width; ++i) {
                    BlockPos blockpos = this.bottomLeft.offset(this.rightDir, i)
                        .up(this.height);
                    WrapperBlock wrapperBlock = this.world.getBlockState(blockpos)
                        .getBlock();

                    if (!this.isEmptyBlock(wrapperBlock)) {
                        break label56;
                    }

                    if (wrapperBlock == Blocks.PORTAL) {
                        ++this.portalBlockCount;
                    }

                    if (i == 0) {
                        wrapperBlock = this.world.getBlockState(blockpos.offset(this.leftDir))
                            .getBlock();
                        ...
                        wrapperBlock = this.world.getBlockState(blockpos.offset(this.rightDir))
                            .getBlock();
        ...
        protected boolean isEmptyBlock(WrapperBlock wrapperBlockIn) {
            return wrapperBlockIn.blockWrapperMaterial == Material.AIR || wrapperBlockIn == Blocks.FIRE
                || wrapperBlockIn == Blocks.PORTAL;
        }
                ...
                for (int j = 0; j < this.height; ++j) {
                    this.world.setBlockState(
                        ...
                        Blocks.PORTAL.getDefaultState()
                            .withProperty(WrapperBlockPortal.AXIS, this.axis),
                        2);
                }
            }
        }
