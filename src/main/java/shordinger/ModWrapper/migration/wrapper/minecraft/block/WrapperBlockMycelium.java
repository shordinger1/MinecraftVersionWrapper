...
public class WrapperBlockMycelium extends WrapperBlock {

    public static final PropertyBool SNOWY = PropertyBool.create("snowy");

    protected WrapperBlockMycelium() {
                ...
                if (worldIn.getLightFromNeighbors(pos.up()) >= 9) {
                    for (int i = 0; i < 4; ++i) {
                        ...
                        if (iblockstate.getBlock() == Blocks.DIRT
                            && iblockstate.getValue(WrapperBlockDirt.VARIANT) == WrapperBlockDirt.DirtType.DIRT
