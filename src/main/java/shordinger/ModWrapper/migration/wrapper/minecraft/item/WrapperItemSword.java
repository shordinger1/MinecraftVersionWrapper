...
public class WrapperItemSword extends WrapperItem {

    private final float attackDamage;
    private final WrapperItem.ToolMaterial material;

    public WrapperItemSword(WrapperItem.ToolMaterial material) {
