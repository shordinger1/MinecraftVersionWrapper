...
public abstract class WorldGenHugeTrees extends WorldGenAbstractTree {
    ...
    protected final IWrapperBlockState woodMetadata;
    /** Sets the metadata for the leaves used in huge trees */
    protected final IWrapperBlockState leavesMetadata;
    protected int extraRandomHeight;

    public WorldGenHugeTrees(boolean notify, int baseHeightIn, int extraRandomHeightIn,
        IWrapperBlockState woodMetadataIn, IWrapperBlockState leavesMetadataIn) {
        super(notify);
