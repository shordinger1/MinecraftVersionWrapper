...
public interface ICommandManager {
     ...
     */
    int executeCommand(IWrapperCommandSender sender, String rawCommand);
     ...
     * is specified.
     */
    List<String> getTabCompletions(IWrapperCommandSender sender, String input, @Nullable BlockPos pos);

    /**
     * Get a list of commands that the given command sender has access to execute.
     */
    List<ICommand> getPossibleCommands(IWrapperCommandSender sender);
