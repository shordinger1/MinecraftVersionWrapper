...
public class WrapperBlockStairs extends WrapperBlock {

    public static final PropertyDirection FACING = WrapperBlockHorizontal.FACING;
    public static final PropertyEnum<WrapperBlockStairs.EnumHalf> HALF = PropertyEnum.<WrapperBlockStairs.EnumHalf>create(
        "half",
        WrapperBlockStairs.EnumHalf.class);
    public static final PropertyEnum<WrapperBlockStairs.EnumShape> SHAPE = PropertyEnum.<WrapperBlockStairs.EnumShape>create(
        "shape",
        WrapperBlockStairs.EnumShape.class);
    /**
     * B: .. T: xx
     * B: .. T: xx
     */
    ...
    private final WrapperBlock modelWrapperBlock;
    private final IWrapperBlockState modelState;

    protected WrapperBlockStairs(IWrapperBlockState modelState) {
        super(modelState.getBlock().blockMaterial);
        this.setDefaultState(
            this.blockState.getBaseState()
                .withProperty(FACING, EnumFacing.NORTH)
                .withProperty(HALF, WrapperBlockStairs.EnumHalf.BOTTOM)
                .withProperty(SHAPE, WrapperBlockStairs.EnumShape.STRAIGHT));
        this.modelWrapperBlock = modelState.getBlock();
        this.modelState = modelState;
        this.setHardness(this.modelWrapperBlock.blockHardness);
        this.setResistance(this.modelWrapperBlock.blockResistance / 3.0F);
        this.setSoundType(this.modelWrapperBlock.blockSoundType);
    ...
    private static List<AxisAlignedBB> getCollisionBoxList(IWrapperBlockState bstate) {
        List<AxisAlignedBB> list = Lists.<AxisAlignedBB>newArrayList();
        boolean flag = bstate.getValue(HALF) == WrapperBlockStairs.EnumHalf.TOP;
        list.add(flag ? AABB_SLAB_TOP : AABB_SLAB_BOTTOM);
        WrapperBlockStairs.EnumShape blockstairs$enumshape = (WrapperBlockStairs.EnumShape) bstate.getValue(SHAPE);

        if (blockstairs$enumshape == WrapperBlockStairs.EnumShape.STRAIGHT
            || blockstairs$enumshape == WrapperBlockStairs.EnumShape.INNER_LEFT
            || blockstairs$enumshape == WrapperBlockStairs.EnumShape.INNER_RIGHT) {
     ...
     */
    private static AxisAlignedBB getCollQuarterBlock(IWrapperBlockState bstate) {
        boolean flag = bstate.getValue(HALF) == WrapperBlockStairs.EnumHalf.TOP;
     ...
     * case of INSIDE).
     */
    private static AxisAlignedBB getCollEighthBlock(IWrapperBlockState bstate) {
        EnumFacing enumfacing = (EnumFacing) bstate.getValue(FACING);
        EnumFacing enumfacing1;

        switch ((WrapperBlockStairs.EnumShape) bstate.getValue(SHAPE)) {
            case OUTER_LEFT:
            default:
    ...
    public BlockFaceShape getBlockFaceShape(IBlockAccess worldIn, IWrapperBlockState state, BlockPos pos,
        ...
        if (face.getAxis() == EnumFacing.Axis.Y) {
            return face == EnumFacing.UP == (state.getValue(HALF) == WrapperBlockStairs.EnumHalf.TOP)
                ? BlockFaceShape.SOLID
                : BlockFaceShape.UNDEFINED;
        } else {
            WrapperBlockStairs.EnumShape blockstairs$enumshape = (WrapperBlockStairs.EnumShape) state.getValue(SHAPE);

            if (blockstairs$enumshape != WrapperBlockStairs.EnumShape.OUTER_LEFT
                && blockstairs$enumshape != WrapperBlockStairs.EnumShape.OUTER_RIGHT) {
    ...
    public void randomDisplayTick(IWrapperBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        this.modelWrapperBlock.randomDisplayTick(stateIn, worldIn, pos, rand);
    }

    public void onBlockClicked(World worldIn, BlockPos pos, EntityPlayer playerIn) {
        this.modelWrapperBlock.onBlockClicked(worldIn, pos, playerIn);
    }
    ...
    public void onBlockDestroyedByPlayer(World worldIn, BlockPos pos, IWrapperBlockState state) {
        this.modelWrapperBlock.onBlockDestroyedByPlayer(worldIn, pos, state);
    }
    ...
    public float getExplosionResistance(Entity exploder) {
        return this.modelWrapperBlock.getExplosionResistance(exploder);
    }
    ...
    public int tickRate(World worldIn) {
        return this.modelWrapperBlock.tickRate(worldIn);
    }

    public Vec3d modifyAcceleration(World worldIn, BlockPos pos, Entity entityIn, Vec3d motion) {
        return this.modelWrapperBlock.modifyAcceleration(worldIn, pos, entityIn, motion);
    }
    ...
    public BlockRenderLayer getBlockLayer() {
        return this.modelWrapperBlock.getBlockLayer();
    }
    ...
    public boolean isCollidable() {
        return this.modelWrapperBlock.isCollidable();
    }

    public boolean canCollideCheck(IWrapperBlockState state, boolean hitIfLiquid) {
        return this.modelWrapperBlock.canCollideCheck(state, hitIfLiquid);
    }
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        return this.modelWrapperBlock.canPlaceBlockAt(worldIn, pos);
    }
    ...
    public void onBlockAdded(World worldIn, BlockPos pos, IWrapperBlockState state) {
        ...
        this.modelWrapperBlock.onBlockAdded(worldIn, pos, this.modelState);
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IWrapperBlockState state) {
        this.modelWrapperBlock.breakBlock(worldIn, pos, this.modelState);
    }
    ...
    public void onEntityWalk(World worldIn, BlockPos pos, Entity entityIn) {
        this.modelWrapperBlock.onEntityWalk(worldIn, pos, entityIn);
    }

    public void updateTick(World worldIn, BlockPos pos, IWrapperBlockState state, Random rand) {
        this.modelWrapperBlock.updateTick(worldIn, pos, state, rand);
    }
    ...
    public void onBlockDestroyedByExplosion(World worldIn, BlockPos pos, Explosion explosionIn) {
        this.modelWrapperBlock.onBlockDestroyedByExplosion(worldIn, pos, explosionIn);
    }
    ...
    public boolean isTopSolid(IWrapperBlockState state) {
        return state.getValue(HALF) == WrapperBlockStairs.EnumHalf.TOP;
    }
    ...
    public MapColor getMapColor(IWrapperBlockState state, IBlockAccess worldIn, BlockPos pos) {
        return this.modelWrapperBlock.getMapColor(this.modelState, worldIn, pos);
    }
    ...
    public IWrapperBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX,
        ...
        return facing != EnumFacing.DOWN && (facing == EnumFacing.UP || (double) hitY <= 0.5D)
            ? iblockstate.withProperty(HALF, WrapperBlockStairs.EnumHalf.BOTTOM)
            : iblockstate.withProperty(HALF, WrapperBlockStairs.EnumHalf.TOP);
    }
    ...
    public IWrapperBlockState getStateFromMeta(int meta) {
        IWrapperBlockState iblockstate = this.getDefaultState()
            .withProperty(HALF, (meta & 4) > 0 ? WrapperBlockStairs.EnumHalf.TOP : WrapperBlockStairs.EnumHalf.BOTTOM);
    ...
    public int getMetaFromState(IWrapperBlockState state) {
        ...
        if (state.getValue(HALF) == WrapperBlockStairs.EnumHalf.TOP) {
            i |= 4;
        }
    ...
    private static WrapperBlockStairs.EnumShape getStairsShape(IWrapperBlockState p_185706_0_, IBlockAccess p_185706_1_,
        BlockPos p_185706_2_) {
        EnumFacing enumfacing = (EnumFacing) p_185706_0_.getValue(FACING);
        IWrapperBlockState iblockstate = p_185706_1_.getBlockState(p_185706_2_.offset(enumfacing));
        ...
        if (isBlockStairs(iblockstate) && p_185706_0_.getValue(HALF) == iblockstate.getValue(HALF)) {
            ...
            if (enumfacing1.getAxis() != ((EnumFacing) p_185706_0_.getValue(FACING)).getAxis()
                ...
                if (enumfacing1 == enumfacing.rotateYCCW()) {
                    return WrapperBlockStairs.EnumShape.OUTER_LEFT;
                }

                return WrapperBlockStairs.EnumShape.OUTER_RIGHT;
            }
        }

        IWrapperBlockState iblockstate1 = p_185706_1_.getBlockState(p_185706_2_.offset(enumfacing.getOpposite()));
        ...
        if (isBlockStairs(iblockstate1) && p_185706_0_.getValue(HALF) == iblockstate1.getValue(HALF)) {
            ...
            if (enumfacing2.getAxis() != ((EnumFacing) p_185706_0_.getValue(FACING)).getAxis()
                ...
                if (enumfacing2 == enumfacing.rotateYCCW()) {
                    return WrapperBlockStairs.EnumShape.INNER_LEFT;
                }

                return WrapperBlockStairs.EnumShape.INNER_RIGHT;
            }
        }

        return WrapperBlockStairs.EnumShape.STRAIGHT;
    }

    private static boolean isDifferentStairs(IWrapperBlockState p_185704_0_, IBlockAccess p_185704_1_,
        BlockPos p_185704_2_, EnumFacing p_185704_3_) {
        IWrapperBlockState iblockstate = p_185704_1_.getBlockState(p_185704_2_.offset(p_185704_3_));
    ...
    public static boolean isBlockStairs(IWrapperBlockState state) {
        return state.getBlock() instanceof WrapperBlockStairs;
    }
                    ...
                    switch (blockstairs$enumshape) {
                        case OUTER_LEFT:
                            return state.withRotation(Rotation.CLOCKWISE_180)
                                .withProperty(SHAPE, WrapperBlockStairs.EnumShape.OUTER_RIGHT);
                        case OUTER_RIGHT:
                            return state.withRotation(Rotation.CLOCKWISE_180)
                                .withProperty(SHAPE, WrapperBlockStairs.EnumShape.OUTER_LEFT);
                        case INNER_RIGHT:
                            return state.withRotation(Rotation.CLOCKWISE_180)
                                .withProperty(SHAPE, WrapperBlockStairs.EnumShape.INNER_LEFT);
                        case INNER_LEFT:
                            return state.withRotation(Rotation.CLOCKWISE_180)
                                .withProperty(SHAPE, WrapperBlockStairs.EnumShape.INNER_RIGHT);
                        default:
                            return state.withRotation(Rotation.CLOCKWISE_180);
                    }
                }
