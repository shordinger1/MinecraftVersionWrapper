...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener {
    ...
    private void updateCollections(boolean p_193003_1_) {
        ...
        list1.removeIf((p_193952_0_) -> { return !p_193952_0_.isNotEmpty(); });
        list1.removeIf((p_193953_0_) -> { return !p_193953_0_.containsValidRecipes(); });
        ...
        if (!s.isEmpty()) {
            ...
            list1.removeIf((p_193947_1_) -> { return !objectset.contains(p_193947_1_); });
        }

        if (this.recipeBook.isFilteringCraftable()) {
            list1.removeIf((p_193958_0_) -> { return !p_193958_0_.containsCraftableRecipes(); });
        }
