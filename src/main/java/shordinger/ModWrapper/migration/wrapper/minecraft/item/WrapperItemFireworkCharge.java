...
public class WrapperItemFireworkCharge extends WrapperItem {

    @SideOnly(Side.CLIENT)
    public static NBTBase getExplosionTag(TempItemStack stack, String key) {
    ...
    public static void addExplosionInfo(NBTTagCompound nbt, List<String> tooltip) {
        ...
        if (aint.length > 0) {
            ...
            for (int i : aint) {
                ...
                for (int j = 0; j < WrapperItemDye.DYE_COLORS.length; ++j) {
                    if (i == WrapperItemDye.DYE_COLORS[j]) {
                        flag1 = true;
        ...
        if (aint1.length > 0) {
            ...
            for (int l : aint1) {
                ...
                for (int k = 0; k < 16; ++k) {
                    if (l == WrapperItemDye.DYE_COLORS[k]) {
                        flag5 = true;
