...
public abstract class EntityLivingBase extends Entity {
    ...
    private boolean canGoThroughtTrapDoorOnLadder(BlockPos pos, IWrapperBlockState state) {
        if (((Boolean) state.getValue(BlockTrapDoor.OPEN)).booleanValue()) {
            IWrapperBlockState iblockstate = this.world.getBlockState(pos.down());
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        if (i > 0) {
            ...
            IWrapperBlockState iblockstate = this.world.getBlockState(new BlockPos(j, k, l));
            ...
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                    if (this.isElytraFlying()) {
                        ...
                        if (this.onGround) {
                            IWrapperBlockState underState = this.world.getBlockState(blockpos$pooledmutableblockpos);
                        ...
                        if (this.onGround) {
                            IWrapperBlockState underState = this.world.getBlockState(
    ...
    public boolean attemptTeleport(double x, double y, double z) {
        ...
        if (world.isBlockLoaded(blockpos)) {
            ...
            while (!flag1 && blockpos.getY() > 0) {
                ...
                IWrapperBlockState iblockstate = world.getBlockState(blockpos1);
