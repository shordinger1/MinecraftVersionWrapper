...
public class WrapperBlockCocoa extends WrapperBlockHorizontal implements IGrowable {
    ...
    public boolean canBlockStay(World worldIn, BlockPos pos, IWrapperBlockState state) {
        ...
        return iblockstate.getBlock() == Blocks.LOG
            && iblockstate.getValue(WrapperBlockOldLog.VARIANT) == WrapperBlockPlanks.EnumType.JUNGLE;
    }
    ...
    private void dropBlock(World worldIn, BlockPos pos, IWrapperBlockState state) {
