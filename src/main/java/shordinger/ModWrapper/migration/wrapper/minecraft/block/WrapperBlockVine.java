...
public class WrapperBlockVine extends WrapperBlock implements net.minecraftforge.common.IShearable {
    ...
    public boolean canAttachTo(World p_193395_1_, BlockPos p_193395_2_, EnumFacing p_193395_3_) {
        WrapperBlock wrapperBlock = p_193395_1_.getBlockState(p_193395_2_.up())
            .getBlock();
        return this.isAcceptableNeighbor(p_193395_1_, p_193395_2_.offset(p_193395_3_.getOpposite()), p_193395_3_)
            && (wrapperBlock == Blocks.AIR || wrapperBlock == Blocks.VINE
    ...
    private boolean isAcceptableNeighbor(World p_193396_1_, BlockPos p_193396_2_, EnumFacing p_193396_3_) {
        IWrapperBlockState iblockstate = p_193396_1_.getBlockState(p_193396_2_);
    ...
    protected static boolean isExceptBlockForAttaching(WrapperBlock p_193397_0_) {
        return p_193397_0_ instanceof WrapperBlockShulkerBox || p_193397_0_ == Blocks.BEACON
    ...
    private boolean recheckGrownSides(World worldIn, BlockPos pos, IWrapperBlockState state) {
        ...
        if (!worldIn.isRemote) {
                                                                              ...
                                                                              // unloaded chunks
            {
                ...
                if (enumfacing1 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(blockpos2)) {
                    IWrapperBlockState iblockstate2 = state;
                    ...
                    .isHorizontal() && !((Boolean) state.getValue(getPropertyFor(enumfacing1))).booleanValue()) {
                        if (!flag) {
                            ...
                            IWrapperBlockState iblockstate3 = worldIn.getBlockState(blockpos4);
                            WrapperBlock wrapperBlock1 = iblockstate3.getBlock();

                            if (wrapperBlock1.isAir(iblockstate3, worldIn, blockpos4)) {
                        ...
                        if (pos.getY() > 1) {
                            ...
                            IWrapperBlockState iblockstate = worldIn.getBlockState(blockpos3);
                            WrapperBlock wrapperBlock = iblockstate.getBlock();

                            if (wrapperBlock.blockWrapperMaterial == Material.AIR) {
                                IWrapperBlockState iblockstate1 = state;
                            ...
                            } else if (wrapperBlock == this) {
                                IWrapperBlockState iblockstate4 = iblockstate;
    ...
    public static int getNumGrownFaces(IWrapperBlockState state) {
        int i = 0;
