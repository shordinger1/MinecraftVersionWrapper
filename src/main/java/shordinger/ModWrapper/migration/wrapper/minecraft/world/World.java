...
import shordinger.ModWrapper.migration.wrapper.minecraft.util.EnumParticleTypes;
import shordinger.ModWrapper.migration.wrapper.minecraft.util.IntHashMap;
...
public abstract class World extends net.minecraft.world.World implements IWrapperBlockAccess, ICapabilityProvider {
     ...
     */
    public WrapperWorldProvider provider;
    ...
    protected World(ISaveHandler saveHandlerIn, WorldInfo info, WrapperWorldProvider providerIn, Profiler profilerIn,
                    boolean client) {
    ...
    public boolean setBlockState(BlockPos pos, IBlockState newState, int flags) {
        if (this.isOutsideBuildHeight(pos)) {
            ...
            IBlockState iblockstate = wrapperChunk.setBlockState(pos, newState);
    ...
    // and physic updates
    public void markAndNotifyBlock(BlockPos pos, @Nullable WrapperChunk wrapperChunk, IBlockState iblockstate,
    ...
    public void playSound(@Nullable EntityPlayer player, double x, double y, double z, SoundEvent soundIn,
        ...
        for (IWorldEventListener eventListener : this.eventListeners) {
            ((IWorldEventListener) eventListener)
    ...
    public void spawnAlwaysVisibleParticle(int p_190523_1_, double p_190523_2_, double p_190523_4_, double p_190523_6_,
        ...
        for (IWorldEventListener eventListener : this.eventListeners) {
            ((IWorldEventListener) eventListener).spawnParticle(
                p_190523_1_,
                false,
                true,
                p_190523_2_,
     ...
     *                 IBlockState#addCollisionBoxToList}. May be null, in which case the world border is
     *                 skipped.
    ...
    public float getCurrentMoonPhaseFactorBody() {
        return WrapperWorldProvider.MOON_PHASE_FACTORS[this.provider.getMoonPhase(this.getWorldTime())];
    }
    ...
    public BlockPos getTopSolidOrLiquidBlock(BlockPos pos) {
        ...
        for (blockpos = new BlockPos(pos.getX(), wrapperChunk.getTopFilledSegment() + 16, pos.getZ()); blockpos.getY()
            ...
            IBlockState state = wrapperChunk.getBlockState(blockpos1);
            ...
            for (int j1 = 0; j1 < this.addedTileEntityList.size(); ++j1) {
                ...
                if (!tileentity1.isInvalid()) {
                    ...
                    if (this.isBlockLoaded(tileentity1.getPos())) {
                        ...
                        IBlockState iblockstate = wrapperChunk.getBlockState(tileentity1.getPos());
