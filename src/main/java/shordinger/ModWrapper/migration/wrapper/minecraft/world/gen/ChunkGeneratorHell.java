...
public class ChunkGeneratorHell implements IChunkGenerator {
    ...
    protected static final IWrapperBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IWrapperBlockState NETHERRACK = Blocks.NETHERRACK.getDefaultState();
    protected static final IWrapperBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
    protected static final IWrapperBlockState LAVA = Blocks.LAVA.getDefaultState();
    protected static final IWrapperBlockState GRAVEL = Blocks.GRAVEL.getDefaultState();
    protected static final IWrapperBlockState SOUL_SAND = Blocks.SOUL_SAND.getDefaultState();
    ...
    public void buildSurfaces(int p_185937_1_, int p_185937_2_, ChunkPrimer primer) {
        ...
        for (int j = 0; j < 16; ++j) {
            for (int k = 0; k < 16; ++k) {
                ...
                int i1 = -1;
                IWrapperBlockState iblockstate = NETHERRACK;
                IWrapperBlockState iblockstate1 = NETHERRACK;

                for (int j1 = 127; j1 >= 0; --j1) {
                    if (j1 < 127 - this.rand.nextInt(5) && j1 > this.rand.nextInt(5)) {
                        IWrapperBlockState iblockstate2 = primer.getBlockState(k, j1, j);
