            ...
            {
                {
                    ...
                    Map<IWrapperBlockState, ModelResourceLocation> map = blockstatemapper.getVariants(block);
                    ...
                    for (Entry<IWrapperBlockState, ModelResourceLocation> entry : map.entrySet()) {
