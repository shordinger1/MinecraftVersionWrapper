...
public class WrapperBlockTorch extends WrapperBlock {
    ...
    private boolean canPlaceAt(World worldIn, BlockPos pos, EnumFacing facing) {
        ...
        if (facing.equals(EnumFacing.UP) && this.canPlaceOn(worldIn, blockpos)) {
            ...
            return !isExceptBlockForAttachWithPiston(wrapperBlock) && blockfaceshape == BlockFaceShape.SOLID;
        } else {
            return false;
        }
    }
    ...
    protected boolean onNeighborChangeInternal(World worldIn, BlockPos pos, IWrapperBlockState state) {
    ...
    protected boolean checkForDrop(World worldIn, BlockPos pos, IWrapperBlockState state) {
