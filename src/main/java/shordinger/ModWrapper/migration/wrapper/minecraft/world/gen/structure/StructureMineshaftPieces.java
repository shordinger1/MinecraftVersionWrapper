...
public class StructureMineshaftPieces {
    ...
    public static class Corridor extends StructureMineshaftPieces.Peice {
        ...
        protected boolean generateChest(World worldIn, StructureBoundingBox structurebb, Random randomIn, int x, int y,
            ...
            if (structurebb.isVecInside(blockpos) && worldIn.getBlockState(blockpos)
                ...
                && worldIn.getBlockState(blockpos.down())
                    .getMaterial() != Material.AIR) {
                IWrapperBlockState iblockstate = Blocks.RAIL.getDefaultState()
                    .withProperty(
                        BlockRail.SHAPE,
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                ...
                IWrapperBlockState iblockstate = this.getPlanksBlock();
                this.fillWithBlocks(
                    worldIn,
                ...
                for (int l2 = 0; l2 <= 2; ++l2) {
                    for (int i3 = 0; i3 <= i1; ++i3) {
                        int k3 = -1;
                        IWrapperBlockState iblockstate3 = this
                ...
                if (this.hasRails) {
                    IWrapperBlockState iblockstate1 = Blocks.RAIL.getDefaultState()
                        .withProperty(BlockRail.SHAPE, BlockRailBase.EnumRailDirection.NORTH_SOUTH);

                    for (int j3 = 0; j3 <= i1; ++j3) {
                        IWrapperBlockState iblockstate2 = this
        ...
        private void placeSupport(World p_189921_1_, StructureBoundingBox p_189921_2_, int p_189921_3_, int p_189921_4_,
            ...
            if (this.isSupportingBox(p_189921_1_, p_189921_2_, p_189921_3_, p_189921_7_, p_189921_6_, p_189921_5_)) {
                IWrapperBlockState iblockstate = this.getPlanksBlock();
                IWrapperBlockState iblockstate1 = this.getFenceBlock();
    ...
    abstract static class Peice extends StructureComponent {
        ...
        protected IWrapperBlockState getPlanksBlock() {
        ...
        protected IWrapperBlockState getFenceBlock() {
            switch (this.mineShaftType) {
                case NORMAL:
                default:
