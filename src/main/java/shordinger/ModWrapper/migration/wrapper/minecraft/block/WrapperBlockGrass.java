...
public class WrapperBlockGrass extends WrapperBlock implements IGrowable {

    public static final PropertyBool SNOWY = PropertyBool.create("snowy");

    protected WrapperBlockGrass() {
                ...
                if (worldIn.getLightFromNeighbors(pos.up()) >= 9) {
                    for (int i = 0; i < 4; ++i) {
                        ...
                        if (iblockstate1.getBlock() == Blocks.DIRT
                            && iblockstate1.getValue(WrapperBlockDirt.VARIANT) == WrapperBlockDirt.DirtType.DIRT
                    ...
                    if (worldIn.isAirBlock(blockpos1)) {
                        if (rand.nextInt(8) == 0) {
                            ...
                            IWrapperBlockState iblockstate1 = Blocks.TALLGRASS.getDefaultState()
                                .withProperty(WrapperBlockTallGrass.TYPE, WrapperBlockTallGrass.EnumType.GRASS);
