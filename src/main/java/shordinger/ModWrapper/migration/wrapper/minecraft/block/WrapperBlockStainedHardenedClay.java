...
public class WrapperBlockStainedHardenedClay extends WrapperBlockColored {

    private static final MapColor[] MAP_COLORS = new MapColor[] { MapColor.WHITE_STAINED_HARDENED_CLAY,
        MapColor.ORANGE_STAINED_HARDENED_CLAY, MapColor.MAGENTA_STAINED_HARDENED_CLAY,
        MapColor.LIGHT_BLUE_STAINED_HARDENED_CLAY, MapColor.YELLOW_STAINED_HARDENED_CLAY,
        MapColor.LIME_STAINED_HARDENED_CLAY, MapColor.PINK_STAINED_HARDENED_CLAY, MapColor.GRAY_STAINED_HARDENED_CLAY,
        MapColor.SILVER_STAINED_HARDENED_CLAY, MapColor.CYAN_STAINED_HARDENED_CLAY,
    ...
    public WrapperBlockStainedHardenedClay() {
        super(Material.ROCK);
    }
