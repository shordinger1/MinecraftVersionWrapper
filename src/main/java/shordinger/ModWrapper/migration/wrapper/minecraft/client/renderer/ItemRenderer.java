...
public class ItemRenderer {
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (this.mc.player.isEntityInsideOpaqueBlock()) {
            IWrapperBlockState iblockstate = this.mc.world.getBlockState(new BlockPos(this.mc.player));
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                IWrapperBlockState iblockstate1 = this.mc.world.getBlockState(blockpos);
