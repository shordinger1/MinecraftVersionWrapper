...
public class WrapperItemTool extends WrapperItem {
    ...
    protected WrapperItemTool(float attackDamageIn, float attackSpeedIn, WrapperItem.ToolMaterial materialIn,
        ...
        if (this instanceof WrapperItemPickaxe) {
            toolClass = "pickaxe";
        } else if (this instanceof WrapperItemAxe) {
            toolClass = "axe";
        } else if (this instanceof WrapperItemSpade) {
            toolClass = "shovel";
        }
    }

    protected WrapperItemTool(WrapperItem.ToolMaterial materialIn, Set<Block> effectiveBlocksIn) {
     ...
     */
    public boolean onBlockDestroyed(TempItemStack stack, World worldIn, IWrapperBlockState state, BlockPos pos,
    ...
    public boolean getIsRepairable(TempItemStack toRepair, TempItemStack repair) {
        TempItemStack mat = this.toolMaterial.getRepairItemStack();
        if (!mat.isEmpty() && net.minecraftforge.oredict.OreDictionary.itemMatches(mat, repair, false)) return false;
    ...
    @Override
    public int getHarvestLevel(TempItemStack stack, String toolClass,
                               @javax.annotation.Nullable net.minecraft.entity.player.EntityPlayer player,
                               @javax.annotation.Nullable IWrapperBlockState blockState) {
    ...
    @Override
    public Set<String> getToolClasses(TempItemStack stack) {
