...
public class EnterBlockTrigger implements ICriterionTrigger<EnterBlockTrigger.Instance> {
    ...
    public void trigger(EntityPlayerMP player, IWrapperBlockState state) {
    ...
    public static class Instance extends AbstractCriterionInstance {
        ...
        public boolean test(IWrapperBlockState state) {
    ...
    static class Listeners {
        ...
        public void trigger(IWrapperBlockState state) {
