...
public class WrapperBlockFarmland extends WrapperBlock {
    ...
    protected WrapperBlockFarmland() {
    ...
    private boolean hasCrops(World worldIn, BlockPos pos) {
        WrapperBlock wrapperBlock = worldIn.getBlockState(pos.up())
            .getBlock();
        return wrapperBlock instanceof net.minecraftforge.common.IPlantable && canSustainPlant(
            worldIn.getBlockState(pos),
            worldIn,
            pos,
            net.minecraft.util.EnumFacing.UP,
            (net.minecraftforge.common.IPlantable) wrapperBlock);
    }
    ...
    public boolean shouldSideBeRendered(IWrapperBlockState blockState, IBlockAccess blockAccess, BlockPos pos,
        ...
        switch (side) {
            ...
            case EAST:
                ...
                return !iblockstate.isOpaqueCube() && wrapperBlock != Blocks.FARMLAND
                    && wrapperBlock != Blocks.GRASS_PATH;
            default:
    ...
    public Item getItemDropped(IWrapperBlockState state, Random rand, int fortune) {
        return Blocks.DIRT.getItemDropped(
            Blocks.DIRT.getDefaultState()
                .withProperty(WrapperBlockDirt.VARIANT, WrapperBlockDirt.DirtType.DIRT),
            rand,
            fortune);
    }
