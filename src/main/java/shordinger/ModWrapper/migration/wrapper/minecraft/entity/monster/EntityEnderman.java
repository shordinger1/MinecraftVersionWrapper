...
public class EntityEnderman extends EntityMob {
    ...
    private static final DataParameter<Optional<IWrapperBlockState>> CARRIED_BLOCK = EntityDataManager
        .<Optional<IWrapperBlockState>>createKey(EntityEnderman.class, DataSerializers.OPTIONAL_BLOCK_STATE);
    ...
    public void writeEntityToNBT(NBTTagCompound compound) {
        ...
        IWrapperBlockState iblockstate = this.getHeldBlockState();
    ...
    public void readEntityFromNBT(NBTTagCompound compound) {
        ...
        IWrapperBlockState iblockstate;
     ...
     */
    public void setHeldBlockState(@Nullable IWrapperBlockState state) {
     ...
     */
    @Nullable
    public IWrapperBlockState getHeldBlockState() {
        return (IWrapperBlockState) ((Optional) this.dataManager.get(CARRIED_BLOCK)).orNull();
    }
    ...
    static class AIPlaceBlock extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            IWrapperBlockState iblockstate2 = this.enderman.getHeldBlockState();
            ...
            if (iblockstate2 != null
                ...
                this.enderman.setHeldBlockState((IWrapperBlockState) null);
            }
        }

        private boolean canPlaceBlock(World p_188518_1_, BlockPos p_188518_2_, Block p_188518_3_,
            IWrapperBlockState p_188518_4_, IWrapperBlockState p_188518_5_) {
