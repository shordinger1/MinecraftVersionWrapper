...
public class WrapperBlockChest extends WrapperBlockContainer {
    ...
    public final WrapperBlockChest.Type chestType;

    protected WrapperBlockChest(WrapperBlockChest.Type chestTypeIn) {
        super(Material.WOOD);
        ...
        this.setCreativeTab(
            chestTypeIn == WrapperBlockChest.Type.TRAP ? CreativeTabs.REDSTONE : CreativeTabs.DECORATIONS);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IWrapperBlockState state, EntityPlayer playerIn,
        ...
        if (worldIn.isRemote) {
            ...
            if (ilockablecontainer != null) {
                ...
                if (this.chestType == WrapperBlockChest.Type.BASIC) {
                    playerIn.addStat(StatList.CHEST_OPENED);
                } else if (this.chestType == WrapperBlockChest.Type.TRAP) {
    ...
    public boolean canProvidePower(IWrapperBlockState state) {
        return this.chestType == WrapperBlockChest.Type.TRAP;
    }
