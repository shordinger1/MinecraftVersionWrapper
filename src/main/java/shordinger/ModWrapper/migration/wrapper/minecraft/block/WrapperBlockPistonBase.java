...
public class WrapperBlockPistonBase extends WrapperBlockDirectional {
    ...
    public WrapperBlockPistonBase(boolean isSticky) {
    ...
    private void checkForMove(World worldIn, BlockPos pos, IWrapperBlockState state) {
        ...
        if (id == 0) {
            ...
            worldIn.setBlockState(
                ...
                Blocks.PISTON_EXTENSION.getDefaultState()
                    .withProperty(WrapperBlockPistonMoving.FACING, enumfacing)
                    .withProperty(
                        WrapperBlockPistonMoving.TYPE,
                        this.isSticky ? WrapperBlockPistonExtension.EnumPistonType.STICKY
                            : WrapperBlockPistonExtension.EnumPistonType.DEFAULT),
                3);
            worldIn.setTileEntity(
                pos,
                WrapperBlockPistonMoving.createTilePiston(this.getStateFromMeta(param), enumfacing, false, true));
            ...
            if (this.isSticky) {
                ...
                if (wrapperBlock == Blocks.PISTON_EXTENSION) {
                ...
                if (!flag1 && !iblockstate.getBlock()
                    ...
                    && (iblockstate.getMobilityFlag() == EnumPushReaction.NORMAL || wrapperBlock == Blocks.PISTON
                        || wrapperBlock == Blocks.STICKY_PISTON)) {
     ...
     */
    public static boolean canPush(IWrapperBlockState blockStateIn, World worldIn, BlockPos pos, EnumFacing facing,
        boolean destroyBlocks, EnumFacing p_185646_5_) {
        WrapperBlock wrapperBlock = blockStateIn.getBlock();

        if (wrapperBlock == Blocks.OBSIDIAN) {
            return false;
            ...
            .contains(pos)) {
                ...
                if (pos.getY() <= worldIn.getHeight() - 1
                    ...
                    return !wrapperBlock.hasTileEntity(blockStateIn);
                } else {
                    return false;
                }
            } else {
    ...
    private boolean doMove(World worldIn, BlockPos pos, EnumFacing direction, boolean extending) {
        ...
        if (!blockpistonstructurehelper.canMove()) {
            ...
            List<IWrapperBlockState> list1 = Lists.<IWrapperBlockState>newArrayList();
            ...
            IWrapperBlockState[] aiblockstate = new IWrapperBlockState[k];
            EnumFacing enumfacing = extending ? direction : direction.getOpposite();

            for (int j = list2.size() - 1; j >= 0; --j) {
                BlockPos blockpos1 = list2.get(j);
                IWrapperBlockState iblockstate = worldIn.getBlockState(blockpos1);
                // Forge: With our change to how snowballs are dropped this needs to disallow to mimic vanilla behavior.
                float chance = iblockstate.getBlock() instanceof WrapperBlockSnow ? -1.0f : 1.0f;
            ...
            for (int l = list.size() - 1; l >= 0; --l) {
                ...
                IWrapperBlockState iblockstate2 = worldIn.getBlockState(blockpos3);
                ...
                worldIn.setTileEntity(
                    blockpos3,
                    WrapperBlockPistonMoving.createTilePiston(list1.get(l), direction, extending, false));
                --k;
            ...
            if (extending) {
                WrapperBlockPistonExtension.EnumPistonType blockpistonextension$enumpistontype = this.isSticky
                    ? WrapperBlockPistonExtension.EnumPistonType.STICKY
                    : WrapperBlockPistonExtension.EnumPistonType.DEFAULT;
                IWrapperBlockState iblockstate3 = Blocks.PISTON_HEAD.getDefaultState()
                    .withProperty(WrapperBlockPistonExtension.FACING, direction)
                    .withProperty(WrapperBlockPistonExtension.TYPE, blockpistonextension$enumpistontype);
                IWrapperBlockState iblockstate1 = Blocks.PISTON_EXTENSION.getDefaultState()
                    .withProperty(WrapperBlockPistonMoving.FACING, direction)
                    .withProperty(
                        WrapperBlockPistonMoving.TYPE,
                        this.isSticky ? WrapperBlockPistonExtension.EnumPistonType.STICKY
                            : WrapperBlockPistonExtension.EnumPistonType.DEFAULT);
                ...
                worldIn.setTileEntity(
                    blockpos2,
                    WrapperBlockPistonMoving.createTilePiston(iblockstate3, direction, true, true));
            }
