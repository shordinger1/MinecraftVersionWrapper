...
public class ResourceLocation extends net.minecraft.util.ResourceLocation {
    ...
    protected ResourceLocation(int unused, String... resourceName) {
        super(org.apache.commons.lang3.StringUtils.isEmpty(resourceName[0]) ? "minecraft"
    ...
    public int compareTo(ResourceLocation p_compareTo_1_) {
        int i = this.getResourceDomain().compareTo(p_compareTo_1_.getResourceDomain());

        if (i == 0) {
            i = this.getResourcePath().compareTo(p_compareTo_1_.getResourcePath());
        }
