...
public class WorldGenTrees extends WorldGenAbstractTree {
    ...
    private static final IWrapperBlockState DEFAULT_TRUNK = Blocks.LOG.getDefaultState()
        .withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK);
    private static final IWrapperBlockState DEFAULT_LEAF = Blocks.LEAVES.getDefaultState()
    ...
    private final IWrapperBlockState metaWood;
    /** The metadata value of the leaves to use in tree generation. */
    private final IWrapperBlockState metaLeaves;

    public WorldGenTrees(boolean p_i2027_1_) {
        this(p_i2027_1_, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }

    public WorldGenTrees(boolean notify, int minTreeHeightIn, IWrapperBlockState woodMeta,
        IWrapperBlockState p_i46446_4_, boolean growVines) {
        super(notify);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= worldIn.getHeight()) {
            ...
            if (!flag) {
                ...
                IWrapperBlockState state = worldIn.getBlockState(position.down());
