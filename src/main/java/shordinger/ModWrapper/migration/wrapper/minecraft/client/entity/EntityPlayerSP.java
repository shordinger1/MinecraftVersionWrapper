package shordinger.ModWrapper.migration.wrapper.minecraft.client.entity;
...
import shordinger.ModWrapper.migration.wrapper.minecraft.util.MovementInput;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    private boolean isOpenBlockSpace(BlockPos pos) {
        IWrapperBlockState iblockstate = world.getBlockState(pos);
                ...
                if (vec2f.x != 0.0F || vec2f.y != 0.0F) {
                    ...
                    if (f13 >= -0.15F) {
                        ...
                        if (iblockstate.getCollisionBoundingBox(this.world, blockpos) == null) {
                            ...
                            IWrapperBlockState iblockstate1 = this.world.getBlockState(blockpos);
                                ...
                                for (AxisAlignedBB axisalignedbb2 : list) {
                                    if (axisalignedbb2.intersects(vec3d7, vec3d8)
                                        ...
                                        while (true) {
                                            ...
                                            IWrapperBlockState iblockstate2 = this.world.getBlockState(blockpos2);
                                            ...
                                            if (i > 1) {
                                                blockpos = blockpos.up();
                                                IWrapperBlockState iblockstate3 = this.world.getBlockState(blockpos);
