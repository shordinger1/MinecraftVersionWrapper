...
public class WrapperItemSnow extends WrapperItemBlock {

    public WrapperItemSnow(Block block) {
        super(block);
        this.setMaxDamage(0);
    }
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
        ...
        if (!itemstack.isEmpty() && player.canPlayerEdit(pos, facing, itemstack)) {
            ...
            if (block == this.block) {
                ...
                if (i < 8) {
                    IWrapperBlockState iblockstate1 = iblockstate
                        .withProperty(BlockSnow.LAYERS, Integer.valueOf(i + 1));
