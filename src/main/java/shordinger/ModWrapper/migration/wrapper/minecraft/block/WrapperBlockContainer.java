...
public abstract class WrapperBlockContainer extends WrapperBlock implements ITileEntityProvider {

    protected WrapperBlockContainer(Material materialIn) {
        this(materialIn, materialIn.getMaterialMapColor());
    }

    protected WrapperBlockContainer(Material materialIn, MapColor color) {
