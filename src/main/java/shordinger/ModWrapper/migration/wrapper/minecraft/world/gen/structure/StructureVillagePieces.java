package shordinger.ModWrapper.migration.wrapper.minecraft.world.gen.structure;
...
public class StructureVillagePieces {
    ...
    public static class Church extends StructureVillagePieces.Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate = Blocks.COBBLESTONE.getDefaultState();
            IWrapperBlockState iblockstate1 = this.getBiomeSpecificBlockState(
                Blocks.STONE_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.NORTH));
            IWrapperBlockState iblockstate2 = this.getBiomeSpecificBlockState(
                Blocks.STONE_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.WEST));
            IWrapperBlockState iblockstate3 = this.getBiomeSpecificBlockState(
                Blocks.STONE_STAIRS.getDefaultState()
            ...
            IWrapperBlockState iblockstate4 = Blocks.LADDER.getDefaultState()
    ...
    public static class Field1 extends StructureVillagePieces.Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.LOG.getDefaultState());
            this.fillWithBlocks(
                worldIn,
                structureBoundingBoxIn,
                0,
    ...
    public static class Hall extends StructureVillagePieces.Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.COBBLESTONE.getDefaultState());
            IWrapperBlockState iblockstate1 = this.getBiomeSpecificBlockState(
            ...
            IWrapperBlockState iblockstate3 = this.getBiomeSpecificBlockState(
                Blocks.OAK_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.WEST));
            IWrapperBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
            IWrapperBlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.LOG.getDefaultState());
            IWrapperBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
            this.fillWithBlocks(
                worldIn,
                structureBoundingBoxIn,
                1,
            ...
            IWrapperBlockState iblockstate7 = iblockstate1;
            IWrapperBlockState iblockstate8 = iblockstate2;
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate3 = this.getBiomeSpecificBlockState(
                Blocks.OAK_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.EAST));
            IWrapperBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
            IWrapperBlockState iblockstate5 = this.getBiomeSpecificBlockState(
                Blocks.STONE_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.NORTH));
            IWrapperBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
            this.fillWithBlocks(
    ...
    public static class House2 extends StructureVillagePieces.Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate2 = this.getBiomeSpecificBlockState(
                Blocks.OAK_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.WEST));
            IWrapperBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
            IWrapperBlockState iblockstate4 = this.getBiomeSpecificBlockState(
                Blocks.STONE_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.NORTH));
            IWrapperBlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.LOG.getDefaultState());
            IWrapperBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
    ...
    public static class House3 extends StructureVillagePieces.Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate4 = this.getBiomeSpecificBlockState(
                Blocks.OAK_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.WEST));
            IWrapperBlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
            IWrapperBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.LOG.getDefaultState());
            this.fillWithBlocks(
                worldIn,
                structureBoundingBoxIn,
                1,
            ...
            IWrapperBlockState iblockstate7 = iblockstate1;
            IWrapperBlockState iblockstate8 = iblockstate2;
            IWrapperBlockState iblockstate9 = iblockstate4;
            IWrapperBlockState iblockstate10 = iblockstate3;
    ...
    public static class House4Garden extends StructureVillagePieces.Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.COBBLESTONE.getDefaultState());
            IWrapperBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
            IWrapperBlockState iblockstate2 = this.getBiomeSpecificBlockState(
                Blocks.STONE_STAIRS.getDefaultState()
                    .withProperty(BlockStairs.FACING, EnumFacing.NORTH));
            IWrapperBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.LOG.getDefaultState());
            IWrapperBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
            ...
            if (this.isRoofAccessible) {
                IWrapperBlockState iblockstate5 = Blocks.LADDER.getDefaultState()
    ...
    public static class Path extends StructureVillagePieces.Road {
         ...
         */
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            IWrapperBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.GRASS_PATH.getDefaultState());
            IWrapperBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
            IWrapperBlockState iblockstate2 = this.getBiomeSpecificBlockState(Blocks.GRAVEL.getDefaultState());
            IWrapperBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.COBBLESTONE.getDefaultState());
                ...
                for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j) {
                    ...
                    if (structureBoundingBoxIn.isVecInside(blockpos)) {
                        ...
                        while (blockpos.getY() >= worldIn.getSeaLevel() - 1) {
                            IWrapperBlockState iblockstate4 = worldIn.getBlockState(blockpos);
    ...
    public static class Torch extends StructureVillagePieces.Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
            this.fillWithBlocks(
                worldIn,
                structureBoundingBoxIn,
                0,
    ...
    public abstract static class Village extends StructureComponent {
        ...
        protected IWrapperBlockState getBiomeSpecificBlockState(IWrapperBlockState blockstateIn) {
         ...
         * liquid
         */
        protected void replaceAirAndLiquidDownwards(World worldIn, IWrapperBlockState blockstateIn, int x, int y, int z,
            StructureBoundingBox boundingboxIn) {
            IWrapperBlockState iblockstate = this.getBiomeSpecificBlockState(blockstateIn);
    ...
    public static class Well extends StructureVillagePieces.Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.COBBLESTONE.getDefaultState());
            IWrapperBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
            this.fillWithBlocks(
                worldIn,
                structureBoundingBoxIn,
                1,
