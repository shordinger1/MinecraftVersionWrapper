...
public class StructureNetherBridgePieces {
    ...
    public static class Corridor3 extends StructureNetherBridgePieces.Piece {
         ...
         */
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            IWrapperBlockState iblockstate = Blocks.NETHER_BRICK_STAIRS.getDefaultState()
    ...
    public static class Entrance extends StructureNetherBridgePieces.Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate = Blocks.FLOWING_LAVA.getDefaultState();
    ...
    public static class NetherStalkRoom extends StructureNetherBridgePieces.Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            this.fillWithBlocks(
                ...
                Blocks.NETHER_BRICK.getDefaultState(),
                false);
            IWrapperBlockState iblockstate1 = iblockstate.withProperty(BlockStairs.FACING, EnumFacing.EAST);
            IWrapperBlockState iblockstate2 = iblockstate.withProperty(BlockStairs.FACING, EnumFacing.WEST);
