...
public class WrapperBlockDispenser extends WrapperBlockContainer {
    ...
    protected WrapperBlockDispenser() {
        super(Material.ROCK);
    ...
    private void setDefaultDirection(World worldIn, BlockPos pos, IWrapperBlockState state) {
        if (!worldIn.isRemote) {
