...
public class WorldGenMinable extends WorldGenerator {
    ...
    private final IWrapperBlockState oreBlock;
    /** The number of blocks to generate. */
    private final int numberOfBlocks;
    private final Predicate<IWrapperBlockState> predicate;

    public WorldGenMinable(IWrapperBlockState state, int blockCount) {
        this(state, blockCount, new WorldGenMinable.StonePredicate());
    }

    public WorldGenMinable(IWrapperBlockState state, int blockCount, Predicate<IWrapperBlockState> p_i45631_3_) {
        this.oreBlock = state;
    ...
    static class StonePredicate implements Predicate<IWrapperBlockState> {

        private StonePredicate() {}

        public boolean apply(IWrapperBlockState p_apply_1_) {
