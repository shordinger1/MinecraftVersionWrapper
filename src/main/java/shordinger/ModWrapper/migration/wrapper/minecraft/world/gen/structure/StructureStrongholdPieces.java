...
public class StructureStrongholdPieces {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                ...
                if (this.isLargeRoom) {
                    ...
                    IWrapperBlockState iblockstate1 = Blocks.LADDER.getDefaultState()
                    ...
                    IWrapperBlockState iblockstate = Blocks.TORCH.getDefaultState()
    ...
    public static class PortalRoom extends StructureStrongholdPieces.Stronghold {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            IWrapperBlockState iblockstate3 = Blocks.STONE_BRICK_STAIRS.getDefaultState()
            ...
            IWrapperBlockState iblockstate4 = Blocks.END_PORTAL_FRAME.getDefaultState()
                .withProperty(BlockEndPortalFrame.FACING, EnumFacing.NORTH);
            IWrapperBlockState iblockstate = Blocks.END_PORTAL_FRAME.getDefaultState()
                .withProperty(BlockEndPortalFrame.FACING, EnumFacing.SOUTH);
            IWrapperBlockState iblockstate1 = Blocks.END_PORTAL_FRAME.getDefaultState()
                .withProperty(BlockEndPortalFrame.FACING, EnumFacing.EAST);
            IWrapperBlockState iblockstate2 = Blocks.END_PORTAL_FRAME.getDefaultState()
            ...
            if (flag) {
                IWrapperBlockState iblockstate5 = Blocks.END_PORTAL.getDefaultState();
    ...
    public static class Prison extends StructureStrongholdPieces.Stronghold {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                ...
                IWrapperBlockState iblockstate = Blocks.IRON_DOOR.getDefaultState()
                    .withProperty(BlockDoor.FACING, EnumFacing.WEST);
                IWrapperBlockState iblockstate1 = Blocks.IRON_DOOR.getDefaultState()
                    .withProperty(BlockDoor.FACING, EnumFacing.WEST)
            ...
            if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                ...
                switch (this.roomType) {
                    ...
                    case 2:
                        ...
                        IWrapperBlockState iblockstate = Blocks.LADDER.getDefaultState()
    ...
    public static class Straight extends StructureStrongholdPieces.Stronghold {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                ...
                IWrapperBlockState iblockstate = Blocks.TORCH.getDefaultState()
                    .withProperty(BlockTorch.FACING, EnumFacing.EAST);
                IWrapperBlockState iblockstate1 = Blocks.TORCH.getDefaultState()
                    .withProperty(BlockTorch.FACING, EnumFacing.WEST);
