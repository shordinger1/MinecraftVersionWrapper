    ...
    protected void renderAttackIndicator(float p_184045_1_, ScaledResolution p_184045_2_) {
        ...
        if (gamesettings.thirdPersonView == 0) {
            if (this.mc.playerController.isSpectator() && this.mc.pointedEntity == null) {
                ...
                net.minecraft.block.state.IWrapperBlockState state = this.mc.world.getBlockState(blockpos);
                if (!state.getBlock()
    ...
    public void updateTick() {
        ...
        if (this.mc.player != null) {
            ...
            if (itemstack.isEmpty()) {
                ...
                if (!this.highlightingItemStack.isEmpty() && itemstack.getItem() == this.highlightingItemStack.getItem()
