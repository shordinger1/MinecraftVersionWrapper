...
public class WrapperWorldServer extends WrapperWorld implements IThreadListener {
    ...
    private final WrapperWorldServer.ServerBlockEventList[] blockEventQueue = new WrapperWorldServer.ServerBlockEventList[] {
        new WrapperWorldServer.ServerBlockEventList(), new WrapperWorldServer.ServerBlockEventList() };
    ...
    public WrapperWorldServer(MinecraftServer server, ISaveHandler saveHandlerIn, WorldInfo info, int dimensionId,
        Profiler profilerIn) {
        super(
            saveHandlerIn,
            info,
        ...
        perWorldStorage = new MapStorage(
            new net.minecraftforge.common.WorldSpecificSaveHandler((WrapperWorldServer) this, saveHandlerIn));
                    ...
                    for (ExtendedBlockStorage extendedblockstorage : chunk.getBlockStorageArray()) {
                        if (extendedblockstorage != Chunk.NULL_BLOCK_STORAGE
                            ...
                            for (int i1 = 0; i1 < i; ++i1) {
                                ...
                                int l1 = j1 >> 8 & 15;
                                int i2 = j1 >> 16 & 15;
                                IWrapperBlockState iblockstate = extendedblockstorage.get(k1, i2, l1);
            ...
            new com.google.common.base.Predicate<EntityLivingBase>() {
                ...
                public boolean apply(@Nullable EntityLivingBase p_apply_1_) {
                    return p_apply_1_ != null && p_apply_1_.isEntityAlive()
                        && WrapperWorldServer.this.canSeeSky(p_apply_1_.getPosition());
                }
            });
            ...
            if (i != this.pendingTickListEntriesHashSet.size()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (this.isAreaLoaded(
                        ...
                        nextticklistentry1.position.add(0, 0, 0))) {
                        IWrapperBlockState iblockstate = this.getBlockState(nextticklistentry1.position);
    ...
    public void initialize(WrapperWorldSettings settings) {
     ...
     */
    private void createSpawnPosition(WrapperWorldSettings settings) {
    ...
    protected void saveLevel() throws MinecraftException {
        ...
        for (WrapperWorldServer worldserver : this.mcServer.worlds) {
            if (worldserver instanceof WrapperWorldServerMulti) {
                ((WrapperWorldServerMulti) worldserver).saveAdditionalData();
            }
        }
    ...
    private boolean fireBlockEvent(BlockEventData event) {
        IWrapperBlockState iblockstate = this.getBlockState(event.getPosition());
