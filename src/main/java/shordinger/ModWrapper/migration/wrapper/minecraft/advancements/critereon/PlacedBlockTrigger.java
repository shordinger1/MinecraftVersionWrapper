package shordinger.ModWrapper.migration.wrapper.minecraft.advancements.critereon;
...
public class PlacedBlockTrigger implements ICriterionTrigger<PlacedBlockTrigger.Instance> {
    ...
    public void trigger(EntityPlayerMP player, BlockPos pos, ItemStack item) {
        IWrapperBlockState iblockstate = player.world.getBlockState(pos);
    ...
    public static class Instance extends AbstractCriterionInstance {
        ...
        public boolean test(IWrapperBlockState state, BlockPos pos, WorldServer world, ItemStack item) {
    ...
    static class Listeners {
        ...
        public void trigger(IWrapperBlockState state, BlockPos pos, WorldServer world, ItemStack item) {
