...
public class WrapperBlockTNT extends WrapperBlock {

    public static final PropertyBool EXPLODE = PropertyBool.create("explode");

    public WrapperBlockTNT() {
        super(Material.TNT);
    ...
    public void explode(World worldIn, BlockPos pos, IWrapperBlockState state, EntityLivingBase igniter) {
        if (!worldIn.isRemote) {
