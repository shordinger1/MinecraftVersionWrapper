...
public class ChunkGeneratorDebug implements IChunkGenerator {
    ...
    private static final List<IWrapperBlockState> ALL_VALID_STATES = Lists.<IWrapperBlockState>newArrayList();
    private static final int GRID_WIDTH;
    private static final int GRID_HEIGHT;
    protected static final IWrapperBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IWrapperBlockState BARRIER = Blocks.BARRIER.getDefaultState();
    ...
    public Chunk generateChunk(int x, int z) {
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                ...
                IWrapperBlockState iblockstate = getBlockStateFor(k, l);
    ...
    public static IWrapperBlockState getBlockStateFor(int p_177461_0_, int p_177461_1_) {
        IWrapperBlockState iblockstate = AIR;
