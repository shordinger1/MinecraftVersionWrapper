package shordinger.ModWrapper.migration.wrapper.minecraft.network.datasync;
...
import shordinger.ModWrapper.migration.wrapper.minecraft.util.math.Rotations;
...
public class DataSerializers {
    ...
    public static final DataSerializer<Optional<IWrapperBlockState>> OPTIONAL_BLOCK_STATE = new DataSerializer<Optional<IWrapperBlockState>>() {

        public void write(PacketBuffer buf, Optional<IWrapperBlockState> value) {
            if (value.isPresent()) {
        ...
        public Optional<IWrapperBlockState> read(PacketBuffer buf) throws IOException {
            int i = buf.readVarInt();
            return i == 0 ? Optional.absent() : Optional.of(Block.getStateById(i));
        }

        public DataParameter<Optional<IWrapperBlockState>> createKey(int id) {
            return new DataParameter<Optional<IWrapperBlockState>>(id, this);
        }

        public Optional<IWrapperBlockState> copyValue(Optional<IWrapperBlockState> value) {
            return value;
        }
    };
