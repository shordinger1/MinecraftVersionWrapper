package shordinger.ModWrapper.migration.wrapper.minecraft.crash;
...
public class CrashReportCategory {
    ...
    public static void addBlockInfo(CrashReportCategory category, final BlockPos pos, final IWrapperBlockState state) {
