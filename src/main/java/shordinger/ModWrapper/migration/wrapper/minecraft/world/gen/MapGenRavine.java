...
public class MapGenRavine extends MapGenBase {
    ...
    protected static final IWrapperBlockState FLOWING_LAVA = Blocks.FLOWING_LAVA.getDefaultState();
    ...
    protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop) {
        net.minecraft.world.biome.Biome biome = world.getBiome(new BlockPos(x + chunkX * 16, 0, z + chunkZ * 16));
        IWrapperBlockState state = data.getBlockState(x, y, z);
        IWrapperBlockState top = isExceptionBiome(biome) ? Blocks.GRASS.getDefaultState() : biome.topBlock;
        IWrapperBlockState filler = isExceptionBiome(biome) ? Blocks.DIRT.getDefaultState() : biome.fillerBlock;
