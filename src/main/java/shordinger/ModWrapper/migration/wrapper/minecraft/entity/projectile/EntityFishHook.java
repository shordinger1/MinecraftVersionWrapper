package shordinger.ModWrapper.migration.wrapper.minecraft.entity.projectile;
    ...
    private void catchingFish(BlockPos p_190621_1_) {
        ...
        if (this.ticksCatchable > 0) {
            ...
            if (this.ticksCatchableDelay > 0) {
                ...
                IWrapperBlockState state = worldserver.getBlockState(new BlockPos(d0, d1 - 1.0D, d2));
            ...
            if (this.rand.nextFloat() < f5) {
                ...
                IWrapperBlockState state = worldserver.getBlockState(new BlockPos((int) d4, (int) d5 - 1, (int) d6));
