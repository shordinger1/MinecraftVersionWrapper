...
public class Material extends net.minecraft.block.material.Material {
    ...
    public static final Material GLASS = (Material) (new Material(MapColor.AIR)).setTranslucent()
        .setAdventureModeExempt();
    public static final Material REDSTONE_LIGHT = (Material) (new Material(MapColor.AIR)).setAdventureModeExempt();
    ...
    public static final Material ICE = (Material) (new Material(MapColor.ICE)).setTranslucent()
        .setAdventureModeExempt();
    public static final Material PACKED_ICE = (Material) (new Material(MapColor.ICE)).setAdventureModeExempt();
    ...
    public net.minecraft.block.material.MapColor getMaterialMapColor() {
        return this.materialMapColor.getMapColor();
    }
