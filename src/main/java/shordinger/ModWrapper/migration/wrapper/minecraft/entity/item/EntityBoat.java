            ...
            for (int k1 = k; k1 < l; ++k1) {
                ...
                while (true) {
                    ...
                    for (int i2 = i1; i2 < j1; ++i2) {
                        ...
                        IWrapperBlockState iblockstate = this.world.getBlockState(blockpos$pooledmutableblockpos);
                    ...
                    if (j2 != 2) {
                        for (int k2 = k; k2 < l; ++k2) {
                            if (j2 <= 0 || k2 != k && k2 != l - 1) {
                                ...
                                IWrapperBlockState iblockstate = this.world
                                    .getBlockState(blockpos$pooledmutableblockpos);
