...
public class WrapperBlockWorkbench extends WrapperBlock {

    protected WrapperBlockWorkbench() {
        super(Material.WOOD);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IWrapperBlockState state, EntityPlayer playerIn,
        ...
        if (worldIn.isRemote) {
            ...
            playerIn.displayGui(new WrapperBlockWorkbench.InterfaceCraftingTable(worldIn, pos));
