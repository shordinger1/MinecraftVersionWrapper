...
public class WrapperBlockPistonMoving extends WrapperBlockContainer {

    public static final PropertyDirection FACING = WrapperBlockPistonExtension.FACING;
    public static final PropertyEnum<WrapperBlockPistonExtension.EnumPistonType> TYPE = WrapperBlockPistonExtension.TYPE;

    public WrapperBlockPistonMoving() {
    ...
    public void onBlockDestroyedByPlayer(World worldIn, BlockPos pos, IWrapperBlockState state) {
        ...
        if (iblockstate.getBlock() instanceof WrapperBlockPistonBase
    ...
    public IWrapperBlockState getStateFromMeta(int meta) {
        return this.getDefaultState()
            .withProperty(FACING, WrapperBlockPistonExtension.getFacing(meta))
            .withProperty(
                TYPE,
