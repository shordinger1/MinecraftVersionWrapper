...
public abstract class Biome extends IForgeRegistryEntry.Impl<Biome> {
        ...
        for (int j1 = 255; j1 >= 0; --j1) {
            if (j1 <= rand.nextInt(5)) {
                ...
                if (iblockstate2.getMaterial() == Material.AIR) {
                    j = -1;
                } else if (iblockstate2.getBlock() == WrapperBlocks.STONE) {
                    if (j == -1) {
                        if (k <= 0) {
                            iblockstate = AIR;
                            iblockstate1 = STONE;
                        ...
                        if (j == 0 && iblockstate1.getBlock() == WrapperBlocks.SAND && k > 1) {
    ...
    public static class FlowerEntry extends WeightedRandom.Item {
        ...
        public final net.minecraft.block.state.IWrapperBlockState state;

        public FlowerEntry(net.minecraft.block.state.IWrapperBlockState state, int weight) {
            super(weight);
            this.state = state;
        }
    }
    ...
    public void addDefaultFlowers() {
        addFlower(
            WrapperBlocks.YELLOW_FLOWER.getDefaultState()
                .withProperty(WrapperBlocks.YELLOW_FLOWER.getTypeProperty(), BlockFlower.EnumFlowerType.DANDELION),
            20);
        addFlower(
            WrapperBlocks.RED_FLOWER.getDefaultState()
                .withProperty(WrapperBlocks.RED_FLOWER.getTypeProperty(), BlockFlower.EnumFlowerType.POPPY),
            10);
    }
