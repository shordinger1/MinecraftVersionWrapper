...
public class WrapperItemDye extends WrapperItem {
            ...
            if (enumdyecolor == EnumDyeColor.WHITE) {
                ...
                if (block == Blocks.LOG && iblockstate.getValue(BlockOldLog.VARIANT) == BlockPlanks.EnumType.JUNGLE) {
                    ...
                    if (worldIn.isAirBlock(pos)) {
                        IWrapperBlockState iblockstate1 = Blocks.COCOA
    ...
    public static boolean applyBonemeal(TempItemStack stack, World worldIn, BlockPos target) {
    ...
    public static boolean applyBonemeal(TempItemStack stack, World worldIn, BlockPos target, EntityPlayer player,
                                        @javax.annotation.Nullable EnumHand hand) {
        IWrapperBlockState iblockstate = worldIn.getBlockState(target);
