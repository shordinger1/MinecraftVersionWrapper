...
public class ChunkGeneratorEnd implements IChunkGenerator {
    ...
    protected static final IWrapperBlockState END_STONE = Blocks.END_STONE.getDefaultState();
    ...
    public void buildSurfaces(ChunkPrimer primer) {
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                int k = 1;
                int l = -1;
                IWrapperBlockState iblockstate = END_STONE;
                IWrapperBlockState iblockstate1 = END_STONE;

                for (int i1 = 127; i1 >= 0; --i1) {
                    IWrapperBlockState iblockstate2 = primer.getBlockState(i, i1, j);
