...
public class BlockDoublePlant extends BlockBush
    ...
    private BlockDoublePlant.EnumPlantType getType(IBlockAccess blockAccess, BlockPos pos,
    ...
    public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
        for (BlockDoublePlant.EnumPlantType blockdoubleplant$enumplanttype : BlockDoublePlant.EnumPlantType
            .values()) {
