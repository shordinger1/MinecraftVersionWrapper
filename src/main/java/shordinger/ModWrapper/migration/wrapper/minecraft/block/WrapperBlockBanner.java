...
public class WrapperBlockBanner extends WrapperBlockContainer {
    ...
    public static class WrapperBlockBannerHanging extends WrapperBlockBanner {
        ...
        public WrapperBlockBannerHanging() {
    ...
    public static class WrapperBlockBannerStanding extends WrapperBlockBanner {

        public WrapperBlockBannerStanding() {
            this.setDefaultState(
                this.blockState.getBaseState()
