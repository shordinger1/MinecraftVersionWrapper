...
public class WorldGenBirchTree extends WorldGenAbstractTree {
    ...
    private static final IWrapperBlockState LOG = Blocks.LOG.getDefaultState()
            ...
            if (!flag) {
                ...
                if (isSoil && position.getY() < worldIn.getHeight() - i - 1) {
                        ...
                        for (int i3 = position.getX() - l2; i3 <= position.getX() + l2; ++i3) {
                            ...
                            for (int k1 = position.getZ() - l2; k1 <= position.getZ() + l2; ++k1) {
                                ...
                                if (Math.abs(j1) != l2 || Math.abs(l1) != l2 || rand.nextInt(2) != 0 && k2 != 0) {
                                    ...
                                    IWrapperBlockState state2 = worldIn.getBlockState(blockpos);
                    ...
                    for (int j2 = 0; j2 < i; ++j2) {
                        ...
                        IWrapperBlockState state2 = worldIn.getBlockState(upN);
