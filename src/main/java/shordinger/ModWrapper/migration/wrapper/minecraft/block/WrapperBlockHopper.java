...
public class WrapperBlockHopper extends WrapperBlockContainer {
    ...
    private void updateState(World worldIn, BlockPos pos, IWrapperBlockState state) {
