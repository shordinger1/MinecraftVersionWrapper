package shordinger.ModWrapper.migration.wrapper.minecraft.client.renderer.tileentity;
...
public class TileEntityPistonRenderer extends TileEntitySpecialRenderer<TileEntityPiston> {
    ...
    public void render(TileEntityPiston te, double x, double y, double z, float partialTicks, int destroyStage,
        ...
        IWrapperBlockState iblockstate = te.getPistonState();
        ...
        if (iblockstate.getMaterial() != Material.AIR && te.getProgress(partialTicks) < 1.0F) {
            ...
            if (block == Blocks.PISTON_HEAD && te.getProgress(partialTicks) <= 0.25F) {
                ...
                IWrapperBlockState iblockstate1 = Blocks.PISTON_HEAD.getDefaultState()
    ...
    private boolean renderStateModel(BlockPos pos, IWrapperBlockState state, BufferBuilder buffer, World p_188186_4_,
        boolean checkSides) {
