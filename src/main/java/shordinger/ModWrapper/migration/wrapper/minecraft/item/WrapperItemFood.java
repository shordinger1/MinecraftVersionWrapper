...
public class WrapperItemFood extends WrapperItem {
    ...
    public WrapperItemFood(int amount, float saturation, boolean isWolfFood) {
    ...
    public WrapperItemFood(int amount, boolean isWolfFood) {
    ...
    public WrapperItemFood setPotionEffect(PotionEffect effect, float probability) {
     ...
     */
    public WrapperItemFood setAlwaysEdible() {
