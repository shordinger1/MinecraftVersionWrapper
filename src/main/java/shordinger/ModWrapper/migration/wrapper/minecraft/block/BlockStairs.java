...
public class BlockStairs extends Block {
    ...
    protected BlockStairs(IWrapperBlockState modelState) {
    ...
    private static BlockStairs.EnumShape getStairsShape(IWrapperBlockState p_185706_0_, IBlockAccess p_185706_1_,
