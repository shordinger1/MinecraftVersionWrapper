...
import shordinger.ModWrapper.migration.wrapper.minecraft.util.math.Vec3i;
...
public class BlockModelRenderer {
    ...
    public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IWrapperBlockState blockStateIn,
    ...
    public boolean renderModel(IBlockAccess worldIn, IBakedModel modelIn, IWrapperBlockState stateIn, BlockPos posIn,
    ...
    public boolean renderModelSmooth(IBlockAccess worldIn, IBakedModel modelIn, IWrapperBlockState stateIn,
        BlockPos posIn, BufferBuilder buffer, boolean checkSides, long rand) {
        boolean flag = false;
    ...
    public boolean renderModelFlat(IBlockAccess worldIn, IBakedModel modelIn, IWrapperBlockState stateIn,
        BlockPos posIn, BufferBuilder buffer, boolean checkSides, long rand) {
        boolean flag = false;
        BitSet bitset = new BitSet(3);
    ...
    private void renderQuadsSmooth(IBlockAccess blockAccessIn, IWrapperBlockState stateIn, BlockPos posIn,
    ...
    private void fillQuadBounds(IWrapperBlockState stateIn, int[] vertexData, EnumFacing face,
    ...
    private void renderQuadsFlat(IBlockAccess blockAccessIn, IWrapperBlockState stateIn, BlockPos posIn,
        int brightnessIn, boolean ownBrightness, BufferBuilder buffer, List<BakedQuad> list, BitSet bitSet) {
        Vec3d vec3d = stateIn.getOffset(blockAccessIn, posIn);
        double d0 = (double) posIn.getX() + vec3d.x;
        double d1 = (double) posIn.getY() + vec3d.y;
        double d2 = (double) posIn.getZ() + vec3d.z;
    ...
    public void renderModelBrightnessColor(IBakedModel bakedModel, float p_178262_2_, float red, float green,
        float blue) {
        this.renderModelBrightnessColor((IWrapperBlockState) null, bakedModel, p_178262_2_, red, green, blue);
    }

    public void renderModelBrightnessColor(IWrapperBlockState state, IBakedModel p_187495_2_, float p_187495_3_,
    ...
    public void renderModelBrightness(IBakedModel model, IWrapperBlockState state, float brightness,
        boolean p_178266_4_) {
    ...
    class AmbientOcclusionFace {
        ...
        public void updateVertexBrightness(IBlockAccess worldIn, IWrapperBlockState state, BlockPos centerPos,
