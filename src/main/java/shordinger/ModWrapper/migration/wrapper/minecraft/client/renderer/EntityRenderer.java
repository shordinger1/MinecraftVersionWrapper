...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    private float getFOVModifier(float partialTicks, boolean useFOVSetting) {
        if (this.debugView) {
            ...
            IWrapperBlockState iblockstate = ActiveRenderInfo
    ...
    private void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                IWrapperBlockState iblockstate = this.mc.world.getBlockState(blockpos);
        ...
        if (!this.mc.gameSettings.debugCamEnable) {
            ...
            IWrapperBlockState state = ActiveRenderInfo
                .getBlockStateAtEntityViewpoint(this.mc.world, entity, partialTicks);
    ...
    private void addRainParticles() {
        ...
        if (f != 0.0F) {
            ...
            for (int l = 0; l < k; ++l) {
                ...
                IWrapperBlockState iblockstate = world.getBlockState(blockpos2);
    ...
    private void updateFogColor(float partialTicks) {
        ...
        if (this.cloudFog) {
            ...
            IWrapperBlockState viewportState = this.mc.world.getBlockState(viewportPos);
