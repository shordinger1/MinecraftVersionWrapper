...
public class WrapperBlockCake extends WrapperBlock {
    ...
    private boolean eatCake(World worldIn, BlockPos pos, IWrapperBlockState state, EntityPlayer player) {
