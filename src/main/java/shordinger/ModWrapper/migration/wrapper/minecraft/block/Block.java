...
import shordinger.ModWrapper.migration.wrapper.minecraft.pathfinding.PathNodeType;
import shordinger.ModWrapper.migration.wrapper.minecraft.util.BlockRenderLayer;
...
//        .getWrapperBlockstateIDMap();
    ...
    private IBlockState defaultWrapperBlockstate;
     ...
     */
    @Deprecated
    public MapColor getMapColor(IBlockState state, IWrapperBlockAccess worldIn, BlockPos pos) {
     ...
     */
    @Deprecated
    public IBlockState getActualState(IBlockState state, IWrapperBlockAccess worldIn, BlockPos pos) {
        return state;
    }
    ...
    public Block(Material blockMaterialIn, MapColor blockMapColorIn) {
        ...
        this.translucent = !blockMaterialIn.WrapperBlocksLight();
    }
    ...
    protected static boolean isExceptionBlockForAttaching(Block attachBlock) {
        return attachBlock instanceof WrapperBlockshulkerBox || attachBlock instanceof BlockLeaves
            || attachBlock instanceof BlockTrapDoor
            || attachBlock == WrapperBlocks.BEACON
            || attachBlock == WrapperBlocks.CAULDRON
            || attachBlock == WrapperBlocks.GLASS
            || attachBlock == WrapperBlocks.GLOWSTONE
            || attachBlock == WrapperBlocks.ICE
            || attachBlock == WrapperBlocks.SEA_LANTERN
            || attachBlock == WrapperBlocks.STAINED_GLASS;
    }

    protected static boolean isExceptBlockForAttachWithPiston(Block attachBlock) {
        return isExceptionBlockForAttaching(attachBlock) || attachBlock == WrapperBlocks.PISTON
            || attachBlock == WrapperBlocks.STICKY_PISTON
            || attachBlock == WrapperBlocks.PISTON_HEAD;
    }
    ...
    public boolean causesSuffocation(IBlockState state) {
        return this.blockMaterial.WrapperBlocksMovement() && this.getDefaultState()
            .isFullCube();
    }
    ...
    public boolean isPassable(IWrapperBlockAccess worldIn, BlockPos pos) {
        return !this.blockMaterial.WrapperBlocksMovement();
    }
    ...
    @Deprecated
    public float getBlockHardness(IBlockState WrapperBlockstate, World worldIn, BlockPos pos) {
    ...
    @Deprecated
    public AxisAlignedBB getBoundingBox(IBlockState state, IWrapperBlockAccess source, BlockPos pos) {
        return FULL_BLOCK_AABB;
    }

    @Deprecated
    @SideOnly(Side.CLIENT)
    public int getPackedLightmapCoords(IBlockState state, IWrapperBlockAccess source, BlockPos pos) {
        int i = source.getCombinedLight(pos, state.getLightValue(source, pos));

        if (i == 0 && state.getBlock() instanceof WrapperBlockslab) {
            pos = pos.down();
    ...
    @Deprecated
    @SideOnly(Side.CLIENT)
    public boolean shouldSideBeRendered(IBlockState WrapperBlockstate, IWrapperBlockAccess blockAccess, BlockPos pos,
                                        EnumFacing side) {
     ...
     */
    @Deprecated
    public BlockFaceShape getBlockFaceShape(IWrapperBlockAccess worldIn, IBlockState state, BlockPos pos,
                                            EnumFacing face) {
    ...
    @Deprecated
    @Nullable
    public AxisAlignedBB getCollisionBoundingBox(IBlockState WrapperBlockstate, IWrapperBlockAccess worldIn, BlockPos pos) {
     ...
     */
    @Deprecated
    public float getPlayerRelativeBlockHardness(IBlockState state, EntityPlayer player, World worldIn,
                                                BlockPos pos) {
        return net.minecraftforge.common.ForgeHooks.WrapperBlockstrength(state, player, worldIn, pos);
    }

    /**
     * Spawn this Block's drops into the WrapperWorld as EntityItems
     */
    ...
    /**
     * Spawns this Block's drops into the WrapperWorld as EntityItems.
     */
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance,
                                          int fortune) {
    ...
    /**
     * Spawns the given ItemStack as an EntityItem into the WrapperWorld at the given position
     */
    ...
    /**
     * Spawns the given amount of experience into the WrapperWorld as XP orb entities
     */
    ...
    @Deprecated
    @Nullable
    public RayTraceResult collisionRayTrace(IBlockState WrapperBlockstate, World worldIn, BlockPos pos, Vec3d start,
                                            Vec3d end) {
    ...
    @Deprecated
    public int getWeakPower(IBlockState WrapperBlockstate, IWrapperBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
        return 0;
    }
    ...
    @Deprecated
    public int getStrongPower(IBlockState WrapperBlockstate, IWrapperBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
        return 0;
    }
    ...
    @Deprecated
    public int getComparatorInputOverride(IBlockState WrapperBlockstate, World worldIn, BlockPos pos) {
        return 0;
    }
    ...
    @Deprecated
    public Vec3d getOffset(IBlockState state, IWrapperBlockAccess worldIn, BlockPos pos) {
     ...
     */
    public float getSlipperiness(IBlockState state, IWrapperBlockAccess world, BlockPos pos, @Nullable Entity entity) {
        return slipperiness;
    }
     ...
     * @see #getSlipperiness(IBlockState, IWrapperBlockAccess, BlockPos, Entity)
     */
     ...
     */
    public int getLightValue(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
     ...
     */
    public boolean isLadder(IBlockState state, IWrapperBlockAccess world, BlockPos pos, EntityLivingBase entity) {
        return false;
    }
     ...
     */
    public boolean isNormalCube(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
     ...
     */
    public boolean doesSideBlockRendering(IBlockState state, IWrapperBlockAccess world, BlockPos pos, EnumFacing face) {
    ...
    public boolean isSideSolid(IBlockState base_state, IWrapperBlockAccess world, BlockPos pos, EnumFacing side) {
        if (base_state.isTopSolid() && side == EnumFacing.UP) // Short circuit to vanilla function if its true
            return true;

        if (this instanceof WrapperBlockslab) {
            IBlockState state = this.getActualState(base_state, world, pos);
            return base_state.isFullBlock()
                || (state.getValue(WrapperBlockslab.HALF) == WrapperBlockslab.EnumBlockHalf.TOP
                && side == EnumFacing.UP)
                || (state.getValue(WrapperBlockslab.HALF) == WrapperBlockslab.EnumBlockHalf.BOTTOM
                && side == EnumFacing.DOWN);
        } else if (this instanceof BlockFarmland) {
            return (side != EnumFacing.DOWN && side != EnumFacing.UP);
        } else if (this instanceof WrapperBlockstairs) {
            IBlockState state = this.getActualState(base_state, world, pos);
            boolean flipped = state.getValue(WrapperBlockstairs.HALF) == WrapperBlockstairs.EnumHalf.TOP;
            WrapperBlockstairs.EnumShape shape = (WrapperBlockstairs.EnumShape) state
                .getValue(WrapperBlockstairs.SHAPE);
            EnumFacing facing = (EnumFacing) state.getValue(WrapperBlockstairs.FACING);
            if (side == EnumFacing.UP) return flipped;
            if (side == EnumFacing.DOWN) return !flipped;
            if (facing == side) return true;
            if (flipped) {
                if (shape == WrapperBlockstairs.EnumShape.INNER_LEFT) return side == facing.rotateYCCW();
                if (shape == WrapperBlockstairs.EnumShape.INNER_RIGHT) return side == facing.rotateY();
            } else {
                if (shape == WrapperBlockstairs.EnumShape.INNER_LEFT) return side == facing.rotateY();
                if (shape == WrapperBlockstairs.EnumShape.INNER_RIGHT) return side == facing.rotateYCCW();
            }
            return false;
        } else if (this instanceof WrapperBlocksnow) {
            IBlockState state = this.getActualState(base_state, world, pos);
            return ((Integer) state.getValue(WrapperBlocksnow.LAYERS)) >= 8;
     ...
     */
    public boolean isAir(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
    ...
    /**
     * @deprecated use {@link #getDrops(NonNullList, IWrapperBlockAccess, BlockPos, IBlockState, int)}
     */
    @Deprecated
    public List<ItemStack> getDrops(IWrapperBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
     ...
     */
    public void getDrops(NonNullList<ItemStack> drops, IWrapperBlockAccess world, BlockPos pos, IBlockState state,
                         int fortune) {
        Random rand = world instanceof World ? ((net.minecraft.world.World) world).rand : RANDOM;
     ...
     */
    public boolean canCreatureSpawn(IBlockState state, IWrapperBlockAccess world, BlockPos pos,
     ...
     */
    public boolean isBed(IBlockState state, IWrapperBlockAccess world, BlockPos pos, @Nullable Entity player) {
     ...
     */
    @Nullable
    public BlockPos getBedSpawnPosition(IBlockState state, IWrapperBlockAccess world, BlockPos pos,
                                        @Nullable EntityPlayer player) {
        if (world instanceof net.minecraft.world.World) return BlockBed.getSafeExitLocation((net.minecraft.world.World) world, pos, 0);
        return null;
    }
    ...
    public void setBedOccupied(IWrapperBlockAccess world, BlockPos pos, EntityPlayer player, boolean occupied) {
        if (world instanceof net.minecraft.world.World) {
            IBlockState state = world.getWrapperBlockstate(pos);
            state = state.getBlock()
                .getActualState(state, world, pos);
            state = state.withProperty(BlockBed.OCCUPIED, occupied);
            ((net.minecraft.world.World) world).setWrapperBlockstate(pos, state, 4);
        }
    }
     ...
     */
    public EnumFacing getBedDirection(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
    ...
    public boolean isBedFoot(IWrapperBlockAccess world, BlockPos pos) {
        return getActualState(world.getWrapperBlockstate(pos), world, pos).getValue(BlockBed.PART)
     ...
     */
    public boolean canSustainLeaves(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
        return false;
    }
     ...
     */
    public boolean isLeaves(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
     ...
     */
    public boolean canBeReplacedByLeaves(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
     ...
     */
    public boolean isReplaceableOreGen(IBlockState state, IWrapperBlockAccess world, BlockPos pos,
     ...
     */
    public boolean canConnectRedstone(IBlockState state, IWrapperBlockAccess world, BlockPos pos,
     ...
     */
    public boolean canPlaceTorchOnTop(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
     ...
     */
    public boolean canSustainPlant(IBlockState state, IWrapperBlockAccess world, BlockPos pos, EnumFacing direction,
     ...
     */
    public int getLightOpacity(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
     ...
     */
    public boolean canEntityDestroy(IBlockState state, IWrapperBlockAccess world, BlockPos pos, Entity entity) {
     ...
     */
    public int getExpDrop(IBlockState state, IWrapperBlockAccess world, BlockPos pos, int fortune) {
        return 0;
    }
     ...
     */
    public void observedNeighborChange(IBlockState observerState, World world, BlockPos observerPos,
                                       Block changedBlock, BlockPos changedBlockPos) {
    }
     ...
     */
    public boolean shouldCheckWeakPower(IBlockState state, IWrapperBlockAccess world, BlockPos pos, EnumFacing side) {
        return state.isNormalCube();
    }
    ...
    public void setHarvestLevel(String toolClass, int level) {
        java.util.Iterator<IBlockState> itr = getWrapperBlockstate().getValidStates()
            .iterator();
        while (itr.hasNext()) {
     ...
     */
    public IBlockState getExtendedState(IBlockState state, IWrapperBlockAccess world, BlockPos pos) {
        return state;
    }
     ...
     */
    @Nullable
    public Boolean isEntityInsideMaterial(IWrapperBlockAccess world, BlockPos blockpos, IBlockState IBlockState,
                                          Entity entity, double yToTest, Material materialIn, boolean testingHead) {
        return null;
    }
     ...
     * {@link net.minecraft.client.renderer.ActiveRenderInfo#getWrapperBlockstateAtEntityViewpoint(net.minecraft.world.World, Entity, float)}).
     ...
     */
    public IBlockState getStateAtViewpoint(IBlockState state, IWrapperBlockAccess world, BlockPos pos,
                                           Vec3d viewpoint) {
        return state;
    }
    ...
    /**
     * @deprecated use
     * {@link #getAiPathNodeType(IBlockState, IWrapperBlockAccess, BlockPos, net.minecraft.entity.EntityLiving)}
     */
    @Nullable
    @Deprecated // TODO: remove
    public PathNodeType getAiPathNodeType(IBlockState state, IWrapperBlockAccess world,
                                          BlockPos pos) {
     ...
     */
    public boolean doesSideBlockChestOpening(IBlockState WrapperBlockstate, IWrapperBlockAccess world, BlockPos pos,
                                             EnumFacing side) {
...
//            1,
//            "stone",
//            (new WrapperBlockstone()).setHardness(1.5F)
//                .setResistance(10.0F)
...
//            6,
//            "sapling",
//            (new WrapperBlocksapling()).setHardness(0.0F)
//                .setSoundType(SoundType.PLANT)
...
//            9,
//            "water",
//            (new WrapperBlockstaticLiquid(Material.WATER)).setHardness(100.0F)
//                .setLightOpacity(3)
//                .setUnlocalizedName("water")
//                .disableStats());
//        registerBlock(
...
//            11,
//            "lava",
//            (new WrapperBlockstaticLiquid(Material.LAVA)).setHardness(100.0F)
//                .setLightLevel(1.0F)
//                .setUnlocalizedName("lava")
//                .disableStats());
//        registerBlock(
//            12,
//            "sand",
//            (new WrapperBlocksand()).setHardness(0.5F)
...
//            19,
//            "sponge",
//            (new WrapperBlocksponge()).setHardness(0.6F)
//                .setSoundType(SoundType.PLANT)
...
//        WrapperBlock wrapperBlock2 = (new WrapperBlocksandStone()).setSoundType(SoundType.STONE)
//            .setHardness(0.8F)
...
//            63,
//            "standing_sign",
//            (new WrapperBlockstandingSign()).setHardness(1.0F)
//                .setSoundType(SoundType.WOOD)
...
//            67,
//            "stone_stairs",
//            (new WrapperBlockstairs(wrapperBlock.getDefaultState())).setUnlocalizedName("stairsStone"));
//        registerBlock(
//            68,
//            "wall_sign",
...
//            78,
//            "snow_layer",
//            (new WrapperBlocksnow()).setHardness(0.1F)
...
//            88,
//            "soul_sand",
//            (new WrapperBlocksoulSand()).setHardness(0.5F)
//                .setSoundType(SoundType.SAND)
...
//            95,
//            "stained_glass",
//            (new WrapperBlockstainedGlass(Material.GLASS)).setHardness(0.3F)
//                .setSoundType(SoundType.GLASS)
...
//            97,
//            "monster_egg",
//            (new WrapperBlocksilverfish()).setHardness(0.75F)
//                .setUnlocalizedName("monsterStoneEgg"));
//        WrapperBlock wrapperBlock8 = (new WrapperBlockstoneBrick()).setHardness(1.5F)
//            .setResistance(10.0F)
//            .setSoundType(SoundType.STONE)
...
//            104,
//            "pumpkin_stem",
//            (new WrapperBlockstem(wrapperBlock7)).setHardness(0.0F)
//                .setSoundType(SoundType.WOOD)
//                .setUnlocalizedName("pumpkinStem"));
//        registerBlock(
//            105,
//            "melon_stem",
//            (new WrapperBlockstem(wrapperBlock9)).setHardness(0.0F)
//                .setSoundType(SoundType.WOOD)
//                .setUnlocalizedName("pumpkinStem"));
//        registerBlock(
//            106,
...
//            108,
//            "brick_stairs",
//            (new WrapperBlockstairs(wrapperBlock5.getDefaultState())).setUnlocalizedName("stairsBrick"));
//        registerBlock(
//            109,
//            "stone_brick_stairs",
//            (new WrapperBlockstairs(
//                wrapperBlock8.getDefaultState()
//                    .withProperty(WrapperBlockstoneBrick.VARIANT, WrapperBlockstoneBrick.EnumType.DEFAULT)))
...
//            114,
//            "nether_brick_stairs",
//            (new WrapperBlockstairs(wrapperBlock10.getDefaultState())).setUnlocalizedName("stairsNetherBrick"));
...
//                    .withProperty(WrapperBlocksandStone.TYPE, WrapperBlocksandStone.EnumType.SMOOTH)))
...
//            144,
//            "skull",
//            (new WrapperBlockskull()).setHardness(1.0F)
//                .setSoundType(SoundType.STONE)
...
//            (new WrapperBlockstainedHardenedClay()).setHardness(1.25F)
//                .setResistance(7.0F)
//                .setSoundType(SoundType.STONE)
...
//            160,
//            "stained_glass_pane",
//            (new WrapperBlockstainedGlassPane()).setHardness(0.3F)
//                .setSoundType(SoundType.GLASS)
...
//            165,
//            "slime",
//            (new WrapperBlockslime()).setUnlocalizedName("slime")
...
//            169,
//            "sea_lantern",
//            (new WrapperBlockseaLantern(Material.GLASS)).setHardness(0.3F)
//                .setSoundType(SoundType.GLASS)
//                .setLightLevel(1.0F)
...
//            203,
//            "purpur_stairs",
//            (new WrapperBlockstairs(wrapperBlock13.getDefaultState())).setUnlocalizedName("stairsPurpur"));
//        registerBlock(
//            204,
//            "purpur_double_slab",
...
//        registerBlock(217, "structure_void", (new WrapperBlockstructureVoid()).setUnlocalizedName("structureVoid"));
//        registerBlock(
//            218,
//            "observer",
...
//            219,
//            "white_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.WHITE)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxWhite"));
//        registerBlock(
//            220,
//            "orange_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.ORANGE)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxOrange"));
//        registerBlock(
//            221,
//            "magenta_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.MAGENTA)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxMagenta"));
//        registerBlock(
//            222,
//            "light_blue_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.LIGHT_BLUE)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxLightBlue"));
//        registerBlock(
//            223,
//            "yellow_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.YELLOW)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxYellow"));
//        registerBlock(
//            224,
//            "lime_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.LIME)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxLime"));
//        registerBlock(
//            225,
//            "pink_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.PINK)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxPink"));
//        registerBlock(
//            226,
//            "gray_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.GRAY)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxGray"));
//        registerBlock(
//            227,
//            "silver_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.SILVER)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxSilver"));
//        registerBlock(
//            228,
//            "cyan_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.CYAN)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxCyan"));
//        registerBlock(
//            229,
//            "purple_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.PURPLE)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxPurple"));
//        registerBlock(
//            230,
//            "blue_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.BLUE)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxBlue"));
//        registerBlock(
//            231,
//            "brown_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.BROWN)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxBrown"));
//        registerBlock(
//            232,
//            "green_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.GREEN)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxGreen"));
//        registerBlock(
//            233,
//            "red_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.RED)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
//                .setUnlocalizedName("shulkerBoxRed"));
//        registerBlock(
//            234,
//            "black_shulker_box",
//            (new WrapperBlockshulkerBox(EnumDyeColor.BLACK)).setHardness(2.0F)
//                .setSoundType(SoundType.STONE)
...
//            255,
//            "structure_block",
//            (new WrapperBlockstructure()).setBlockUnbreakable()
//                .setResistance(6000000.0F)
...
//            } else {
//                boolean flag = false;
//                boolean flag1 = wrapperBlock15 instanceof WrapperBlockstairs;
//                boolean flag2 = wrapperBlock15 instanceof WrapperBlockslab;
