...
public class BlockModelShapes {
    ...
    public final Map<IWrapperBlockState, IBakedModel> bakedModelStore = Maps
        .<IWrapperBlockState, IBakedModel>newIdentityHashMap();
    ...
    public TextureAtlasSprite getTexture(IWrapperBlockState state) {
    ...
    public void reloadModels() {
        ...
        for (Entry<IWrapperBlockState, ModelResourceLocation> entry : this.blockStateMapper.putAllStateModelLocations()
            .entrySet()) {
