...
public abstract class StructureComponent {
    ...
    protected void setBlockState(World worldIn, IWrapperBlockState blockstateIn, int x, int y, int z,
        StructureBoundingBox boundingboxIn) {
    ...
    protected IWrapperBlockState getBlockStateFromPos(World worldIn, int x, int y, int z,
        StructureBoundingBox boundingboxIn) {
    ...
    protected void fillWithBlocks(World worldIn, StructureBoundingBox boundingboxIn, int xMin, int yMin, int zMin,
        int xMax, int yMax, int zMax, IWrapperBlockState boundaryBlockState, IWrapperBlockState insideBlockState,
    ...
    protected void generateMaybeBox(World worldIn, StructureBoundingBox sbb, Random rand, float chance, int x1, int y1,
        int z1, int x2, int y2, int z2, IWrapperBlockState edgeState, IWrapperBlockState state, boolean requireNonAir,
    ...
    protected void randomlyPlaceBlock(World worldIn, StructureBoundingBox boundingboxIn, Random rand, float chance,
        int x, int y, int z, IWrapperBlockState blockstateIn) {
        if (rand.nextFloat() < chance) {
    ...
    protected void randomlyRareFillWithBlocks(World worldIn, StructureBoundingBox boundingboxIn, int minX, int minY,
        int minZ, int maxX, int maxY, int maxZ, IWrapperBlockState blockstateIn, boolean excludeAir) {
    ...
    protected boolean generateChest(World worldIn, StructureBoundingBox structurebb, Random randomIn, int x, int y,
        ...
        BlockPos blockpos = new BlockPos(this.getXWithOffset(x, z), this.getYWithOffset(y), this.getZWithOffset(x, z));
        return this.generateChest(worldIn, structurebb, randomIn, blockpos, loot, (IWrapperBlockState) null);
    }

    protected boolean generateChest(World p_191080_1_, StructureBoundingBox p_191080_2_, Random p_191080_3_,
        BlockPos p_191080_4_, ResourceLocation p_191080_5_, @Nullable IWrapperBlockState p_191080_6_) {
    ...
    public abstract static class BlockSelector {
        ...
        protected IWrapperBlockState blockstate = Blocks.AIR.getDefaultState();
