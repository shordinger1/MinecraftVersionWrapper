...
public class WrapperBlockRotatedPillar extends WrapperBlock {

    public static final PropertyEnum<EnumFacing.Axis> AXIS = PropertyEnum.<EnumFacing.Axis>create(
        "axis",
        EnumFacing.Axis.class);

    protected WrapperBlockRotatedPillar(Material materialIn) {
        super(materialIn, materialIn.getMaterialMapColor());
    }

    protected WrapperBlockRotatedPillar(Material materialIn, MapColor color) {
        super(materialIn, color);
    }

    @Override
    public boolean rotateBlock(net.minecraft.world.World world, BlockPos pos, EnumFacing axis) {
        net.minecraft.block.state.IWrapperBlockState state = world.getBlockState(pos);
