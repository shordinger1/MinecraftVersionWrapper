...
public class WrapperItemEnchantedBook extends WrapperItem {
    ...
    public static NBTTagList getEnchantments(TempItemStack p_92110_0_) {
     ...
     */
    public static void addEnchantment(TempItemStack p_92115_0_, EnchantmentData stack) {
     ...
     */
    public static TempItemStack getEnchantedItemStack(EnchantmentData p_92111_0_) {
        TempItemStack itemstack = new TempItemStack(Items.ENCHANTED_BOOK);
