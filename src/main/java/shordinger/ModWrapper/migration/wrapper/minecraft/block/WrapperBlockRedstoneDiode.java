...
public abstract class WrapperBlockRedstoneDiode extends WrapperBlockHorizontal {
    ...
    protected WrapperBlockRedstoneDiode(boolean powered) {
        ...
        if (i >= 15) {
            ...
            return Math.max(
                ...
                iblockstate.getBlock() == Blocks.REDSTONE_WIRE
                    ? ((Integer) iblockstate.getValue(WrapperBlockRedstoneWire.POWER)).intValue()
                    : 0);
        }
    }
    ...
    protected int getPowerOnSide(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        ...
        if (this.isAlternateInput(iblockstate)) {
            if (wrapperBlock == Blocks.REDSTONE_BLOCK) {
                return 15;
            } else {
                return wrapperBlock == Blocks.REDSTONE_WIRE
                    ? ((Integer) iblockstate.getValue(WrapperBlockRedstoneWire.POWER)).intValue()
    ...
    public boolean isSameDiode(IWrapperBlockState state) {
        ...
        return wrapperBlock == this.getPoweredState(this.getDefaultState())
            .getBlock() || wrapperBlock
