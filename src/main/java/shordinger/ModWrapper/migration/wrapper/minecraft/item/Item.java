...
public class Item extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<Item> {
    ...
    public float getDestroySpeed(ItemStack stack, IWrapperBlockState state) {
        return 1.0F;
    }
     ...
     */
    public boolean onBlockDestroyed(ItemStack stack, World worldIn, IWrapperBlockState state, BlockPos pos,
    ...
    /**
     * ItemStack sensitive version of {@link #canHarvestBlock(IWrapperBlockState)}
     * 
     * @param state The block trying to harvest
     * @param stack The itemstack used to harvest the block
     * @return true if can harvest the block
     */
    public boolean canHarvestBlock(IWrapperBlockState state, ItemStack stack) {
    ...
    public int getHarvestLevel(ItemStack stack, String toolClass, @Nullable EntityPlayer player,
        @Nullable IWrapperBlockState blockState) {
