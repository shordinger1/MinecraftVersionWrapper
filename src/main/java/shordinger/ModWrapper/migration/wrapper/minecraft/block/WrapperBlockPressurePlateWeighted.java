...
public class WrapperBlockPressurePlateWeighted extends WrapperBlockBasePressurePlate {

    public static final PropertyInteger POWER = PropertyInteger.create("power", 0, 15);
    private final int maxWeight;

    protected WrapperBlockPressurePlateWeighted(Material materialIn, int p_i46379_2_) {
        this(materialIn, p_i46379_2_, materialIn.getMaterialMapColor());
    }

    protected WrapperBlockPressurePlateWeighted(Material materialIn, int p_i46380_2_, MapColor color) {
