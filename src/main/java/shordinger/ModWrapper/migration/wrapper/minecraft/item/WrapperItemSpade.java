...
public class WrapperItemSpade extends WrapperItemTool {
    ...
    public WrapperItemSpade(WrapperItem.ToolMaterial material) {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
        ...
        if (!player.canPlayerEdit(pos.offset(facing), facing, itemstack)) {
            ...
            if (facing != EnumFacing.DOWN && worldIn.getBlockState(pos.up())
                ...
                IWrapperBlockState iblockstate1 = Blocks.GRASS_PATH.getDefaultState();
