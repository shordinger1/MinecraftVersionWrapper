...
public class WrapperItemBlock extends WrapperItem {

    protected final Block block;

    public WrapperItemBlock(Block block) {
        this.block = block;
    }
     ...
     */
    public boolean placeBlockAt(TempItemStack stack, EntityPlayer player, World world, BlockPos pos, EnumFacing side,
                                float hitX, float hitY, float hitZ, IWrapperBlockState newState) {
