...
public abstract class WrapperBlockBasePressurePlate extends WrapperBlock {
    ...
    protected WrapperBlockBasePressurePlate(Material materialIn) {
        this(materialIn, materialIn.getMaterialMapColor());
    }

    protected WrapperBlockBasePressurePlate(Material materialIn, MapColor mapColorIn) {
    ...
    private boolean canBePlacedOn(World worldIn, BlockPos pos) {
        return worldIn.getBlockState(pos)
            ...
            || worldIn.getBlockState(pos)
                .getBlock() instanceof WrapperBlockFence;
    }
     ...
     */
    protected void updateState(World worldIn, BlockPos pos, IWrapperBlockState state, int oldRedstoneStrength) {
    ...
    protected abstract int getRedstoneStrength(IWrapperBlockState state);

    protected abstract IWrapperBlockState setRedstoneStrength(IWrapperBlockState state, int strength);
