...
public class WrapperPotion extends Potion {

    public static final RegistryNamespaced<ResourceLocation, WrapperPotion> REGISTRY = net.minecraftforge.registries.GameData
        .getWrapper(WrapperPotion.class);
    /**
     ...
     */
    @Nullable
    public static WrapperPotion getPotionById(int potionID) {
     ...
     */
    public static int getIdFromPotion(WrapperPotion wrapperPotionIn) {
        return REGISTRY.getIDForObject(wrapperPotionIn);
    }

    @Nullable
    public static WrapperPotion getPotionFromResourceLocation(String location) {
        return REGISTRY.getObject(new ResourceLocation(location));
    }

    protected WrapperPotion(boolean isBadEffectIn, int liquidColorIn) {
     ...
     */
    protected WrapperPotion setIconIndex(int p_76399_1_, int p_76399_2_) {
     ...
     * Set the potion name.
     */
    public WrapperPotion setPotionName(String nameIn) {
        this.name = nameIn;
        return this;
    }
    ...
    protected WrapperPotion setEffectiveness(double effectivenessIn) {
     ...
     */
    public WrapperPotion registerPotionAttributeModifier(IAttribute attribute, String uniqueId, double ammount,
                                                         int operation) {
    ...
    public java.util.List<net.minecraft.item.ItemStack> getCurativeItems() {
        ...
        ret.add(new net.minecraft.item.ItemStack(WrapperItems.milk_bucket));
        return ret;
    }
     ...
     */
    public WrapperPotion setBeneficial() {
...
//            (new WrapperPotion(false, 8171462)).setPotionName("effect.moveSpeed")
//                .setIconIndex(0, 0)
...
//            (new WrapperPotion(true, 5926017)).setPotionName("effect.moveSlowdown")
//                .setIconIndex(1, 0)
//                .registerPotionAttributeModifier(
//                    SharedMonsterAttributes.MOVEMENT_SPEED,
...
//            (new WrapperPotion(false, 14270531)).setPotionName("effect.digSpeed")
//                .setIconIndex(2, 0)
...
//            (new WrapperPotion(true, 4866583)).setPotionName("effect.digSlowDown")
//                .setIconIndex(3, 0)
//                .registerPotionAttributeModifier(
//                    SharedMonsterAttributes.ATTACK_SPEED,
...
//            (new WrapperPotionAttackDamage(false, 9643043, 3.0D)).setPotionName("effect.damageBoost")
//                .setIconIndex(4, 0)
//                .registerPotionAttributeModifier(
...
//            (new WrapperPotionHealth(false, 16262179)).setPotionName("effect.heal")
//                .setBeneficial());
//        REGISTRY.register(
//            7,
//            new ResourceLocation("instant_damage"),
//            (new WrapperPotionHealth(true, 4393481)).setPotionName("effect.harm")
//                .setBeneficial());
//        REGISTRY.register(
//            8,
//            new ResourceLocation("jump_boost"),
//            (new WrapperPotion(false, 2293580)).setPotionName("effect.jump")
//                .setIconIndex(2, 1)
//                .setBeneficial());
//        REGISTRY.register(
//            9,
//            new ResourceLocation("nausea"),
//            (new WrapperPotion(true, 5578058)).setPotionName("effect.confusion")
//                .setIconIndex(3, 1)
//                .setEffectiveness(0.25D));
//        REGISTRY.register(
//            10,
//            new ResourceLocation("regeneration"),
//            (new WrapperPotion(false, 13458603)).setPotionName("effect.regeneration")
//                .setIconIndex(7, 0)
//                .setEffectiveness(0.25D)
//                .setBeneficial());
//        REGISTRY.register(
...
//            (new WrapperPotion(false, 10044730)).setPotionName("effect.resistance")
//                .setIconIndex(6, 1)
//                .setBeneficial());
//        REGISTRY.register(
//            12,
//            new ResourceLocation("fire_resistance"),
//            (new WrapperPotion(false, 14981690)).setPotionName("effect.fireResistance")
//                .setIconIndex(7, 1)
//                .setBeneficial());
//        REGISTRY.register(
//            13,
//            new ResourceLocation("water_breathing"),
//            (new WrapperPotion(false, 3035801)).setPotionName("effect.waterBreathing")
//                .setIconIndex(0, 2)
//                .setBeneficial());
//        REGISTRY.register(
//            14,
//            new ResourceLocation("invisibility"),
//            (new WrapperPotion(false, 8356754)).setPotionName("effect.invisibility")
//                .setIconIndex(0, 1)
//                .setBeneficial());
//        REGISTRY.register(
//            15,
//            new ResourceLocation("blindness"),
//            (new WrapperPotion(true, 2039587)).setPotionName("effect.blindness")
//                .setIconIndex(5, 1)
//                .setEffectiveness(0.25D));
//        REGISTRY.register(
//            16,
//            new ResourceLocation("night_vision"),
//            (new WrapperPotion(false, 2039713)).setPotionName("effect.nightVision")
//                .setIconIndex(4, 1)
//                .setBeneficial());
//        REGISTRY.register(
//            17,
//            new ResourceLocation("hunger"),
//            (new WrapperPotion(true, 5797459)).setPotionName("effect.hunger")
//                .setIconIndex(1, 1));
//        REGISTRY.register(
//            18,
//            new ResourceLocation("weakness"),
//            (new WrapperPotionAttackDamage(true, 4738376, -4.0D)).setPotionName("effect.weakness")
//                .setIconIndex(5, 0)
//                .registerPotionAttributeModifier(
//                    SharedMonsterAttributes.ATTACK_DAMAGE,
...
//            (new WrapperPotion(true, 5149489)).setPotionName("effect.poison")
//                .setIconIndex(6, 0)
//                .setEffectiveness(0.25D));
//        REGISTRY.register(
//            20,
//            new ResourceLocation("wither"),
//            (new WrapperPotion(true, 3484199)).setPotionName("effect.wither")
//                .setIconIndex(1, 2)
//                .setEffectiveness(0.25D));
//        REGISTRY.register(
//            21,
//            new ResourceLocation("health_boost"),
//            (new WrapperPotionHealthBoost(false, 16284963)).setPotionName("effect.healthBoost")
//                .setIconIndex(7, 2)
//                .registerPotionAttributeModifier(
...
//            (new WrapperPotionAbsorption(false, 2445989)).setPotionName("effect.absorption")
//                .setIconIndex(2, 2)
//                .setBeneficial());
//        REGISTRY.register(
//            23,
//            new ResourceLocation("saturation"),
//            (new WrapperPotionHealth(false, 16262179)).setPotionName("effect.saturation")
//                .setBeneficial());
//        REGISTRY.register(
//            24,
//            new ResourceLocation("glowing"),
//            (new WrapperPotion(false, 9740385)).setPotionName("effect.glowing")
//                .setIconIndex(4, 2));
//        REGISTRY.register(
//            25,
//            new ResourceLocation("levitation"),
//            (new WrapperPotion(true, 13565951)).setPotionName("effect.levitation")
//                .setIconIndex(3, 2));
//        REGISTRY.register(
//            26,
//            new ResourceLocation("luck"),
//            (new WrapperPotion(false, 3381504)).setPotionName("effect.luck")
//                .setIconIndex(5, 2)
//                .setBeneficial()
//                .registerPotionAttributeModifier(
...
//            (new WrapperPotion(true, 12624973)).setPotionName("effect.unluck")
//                .setIconIndex(6, 2)
//                .registerPotionAttributeModifier(
//                    SharedMonsterAttributes.LUCK,
