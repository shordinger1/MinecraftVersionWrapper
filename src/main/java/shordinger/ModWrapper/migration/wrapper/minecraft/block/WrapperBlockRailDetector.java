...
public class WrapperBlockRailDetector extends WrapperBlockRailBase {
    ...
    public WrapperBlockRailDetector() {
        super(true);
    ...
    private void updatePoweredState(World worldIn, BlockPos pos, IWrapperBlockState state) {
    ...
    protected void updateConnectedRails(World worldIn, BlockPos pos, IWrapperBlockState state, boolean powered) {
        WrapperBlockRailBase.Rail blockrailbase$rail = new WrapperBlockRailBase.Rail(worldIn, pos, state);
