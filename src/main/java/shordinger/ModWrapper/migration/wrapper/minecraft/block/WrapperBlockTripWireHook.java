...
public class WrapperBlockTripWireHook extends WrapperBlock {
    ...
    public WrapperBlockTripWireHook() {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IWrapperBlockState state, EntityLivingBase placer,
        ItemStack stack) {
        this.calculateState(worldIn, pos, state, false, false, -1, (IWrapperBlockState) null);
    }
    ...
    public void calculateState(World worldIn, BlockPos pos, IWrapperBlockState hookState, boolean p_176260_4_,
        boolean p_176260_5_, int p_176260_6_, @Nullable IWrapperBlockState p_176260_7_) {
        ...
        boolean flag3 = false;
        int i = 0;
        IWrapperBlockState[] aiblockstate = new IWrapperBlockState[42];
        ...
        for (int j = 1; j < 42; ++j) {
            ...
            if (iblockstate.getBlock() != Blocks.TRIPWIRE && j != p_176260_6_) {
                ...
                if (j == p_176260_6_) {
                    iblockstate = (IWrapperBlockState) MoreObjects.firstNonNull(p_176260_7_, iblockstate);
                }

                boolean flag4 = !((Boolean) iblockstate.getValue(WrapperBlockTripWire.DISARMED)).booleanValue();
                boolean flag5 = ((Boolean) iblockstate.getValue(WrapperBlockTripWire.POWERED)).booleanValue();
                flag3 |= flag4 && flag5;
        ...
        flag2 = flag2 & i > 1;
        flag3 = flag3 & flag2;
        IWrapperBlockState iblockstate1 = this.getDefaultState()
        ...
        if (flag != flag2) {
            for (int k = 1; k < i; ++k) {
                ...
                IWrapperBlockState iblockstate2 = aiblockstate[k];
    ...
    public void updateTick(World worldIn, BlockPos pos, IWrapperBlockState state, Random rand) {
        this.calculateState(worldIn, pos, state, false, true, -1, (IWrapperBlockState) null);
    }
    ...
    private boolean checkForDrop(World worldIn, BlockPos pos, IWrapperBlockState state) {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IWrapperBlockState state) {
        ...
        if (flag || flag1) {
            this.calculateState(worldIn, pos, state, true, false, -1, (IWrapperBlockState) null);
        }
