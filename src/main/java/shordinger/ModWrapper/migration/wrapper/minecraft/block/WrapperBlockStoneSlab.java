...
public abstract class WrapperBlockStoneSlab extends WrapperBlockSlab {

    public static final PropertyBool SEAMLESS = PropertyBool.create("seamless");
    public static final PropertyEnum<WrapperBlockStoneSlab.EnumType> VARIANT = PropertyEnum.<WrapperBlockStoneSlab.EnumType>create(
        "variant",
        WrapperBlockStoneSlab.EnumType.class);

    public WrapperBlockStoneSlab() {
        super(Material.ROCK);
        ...
        this.setDefaultState(iblockstate.withProperty(VARIANT, WrapperBlockStoneSlab.EnumType.STONE));
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IWrapperBlockState state) {
        return new ItemStack(
            Blocks.STONE_SLAB,
            1,
            ((WrapperBlockStoneSlab.EnumType) state.getValue(VARIANT)).getMetadata());
    }
    ...
    public String getUnlocalizedName(int meta) {
        return super.getUnlocalizedName() + "."
            + WrapperBlockStoneSlab.EnumType.byMetadata(meta)
                .getUnlocalizedName();
    }
    ...
    public Comparable<?> getTypeForItem(ItemStack stack) {
        return WrapperBlockStoneSlab.EnumType.byMetadata(stack.getMetadata() & 7);
    }
    ...
    public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
        for (WrapperBlockStoneSlab.EnumType blockstoneslab$enumtype : WrapperBlockStoneSlab.EnumType.values()) {
            if (blockstoneslab$enumtype != WrapperBlockStoneSlab.EnumType.WOOD) {
    ...
    public IWrapperBlockState getStateFromMeta(int meta) {
        IWrapperBlockState iblockstate = this.getDefaultState()
            .withProperty(VARIANT, WrapperBlockStoneSlab.EnumType.byMetadata(meta & 7));
    ...
    public int getMetaFromState(IWrapperBlockState state) {
        int i = 0;
        i = i | ((WrapperBlockStoneSlab.EnumType) state.getValue(VARIANT)).getMetadata();
    ...
    public int damageDropped(IWrapperBlockState state) {
        return ((WrapperBlockStoneSlab.EnumType) state.getValue(VARIANT)).getMetadata();
    }
    ...
    public MapColor getMapColor(IWrapperBlockState state, IBlockAccess worldIn, BlockPos pos) {
        return ((WrapperBlockStoneSlab.EnumType) state.getValue(VARIANT)).getMapColor();
    }
    ...
    public static enum EnumType implements IStringSerializable {
        ...
        private static final WrapperBlockStoneSlab.EnumType[] META_LOOKUP = new WrapperBlockStoneSlab.EnumType[values().length];
        ...
        public static WrapperBlockStoneSlab.EnumType byMetadata(int meta) {
        ...
        static {
            for (WrapperBlockStoneSlab.EnumType blockstoneslab$enumtype : values()) {
