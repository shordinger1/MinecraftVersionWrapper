package shordinger.ModWrapper.migration.wrapper.minecraft.pathfinding;
...
public class PathWorldListener implements IWorldEventListener {
    ...
    public void notifyBlockUpdate(World worldIn, BlockPos pos, IWrapperBlockState oldState, IWrapperBlockState newState,
        int flags) {
    ...
    protected boolean didBlockChange(World worldIn, BlockPos pos, IWrapperBlockState oldState,
