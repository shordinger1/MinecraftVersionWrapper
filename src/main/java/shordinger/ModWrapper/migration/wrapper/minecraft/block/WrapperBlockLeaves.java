...
public abstract class WrapperBlockLeaves extends WrapperBlock implements net.minecraftforge.common.IShearable {
    ...
    public abstract WrapperBlockPlanks.EnumType getWoodType(int meta);
    ...
    @Override
    public boolean isLeaves(IWrapperBlockState state, IBlockAccess world, BlockPos pos) {
        return true;
    }
