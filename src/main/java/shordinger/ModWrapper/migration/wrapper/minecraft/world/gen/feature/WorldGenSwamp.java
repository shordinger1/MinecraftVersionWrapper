...
public class WorldGenSwamp extends WorldGenAbstractTree {
    ...
    private static final IWrapperBlockState TRUNK = Blocks.LOG.getDefaultState()
        .withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.OAK);
    private static final IWrapperBlockState LEAF = Blocks.LEAVES.getDefaultState()
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256) {
                    ...
                    for (int i1 = position.getZ() - k; i1 <= position.getZ() + k && flag; ++i1) {
                        if (j >= 0 && j < 256) {
                            IWrapperBlockState iblockstate = worldIn
                                .getBlockState(blockpos$mutableblockpos.setPos(l, j, i1));
            ...
            if (!flag) {
                ...
                IWrapperBlockState state = worldIn.getBlockState(down);
                ...
                if (isSoil && position.getY() < worldIn.getHeight() - i - 1) {
                    ...
                    for (int l1 = 0; l1 < i; ++l1) {
                        ...
                        IWrapperBlockState iblockstate1 = worldIn.getBlockState(upN);
    ...
    private void addVine(World worldIn, BlockPos pos, PropertyBool prop) {
        IWrapperBlockState iblockstate = Blocks.VINE.getDefaultState()
