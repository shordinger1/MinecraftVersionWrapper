...
public class EntityFallingBlock extends Entity {
    ...
    private IWrapperBlockState fallTile;
    public int fallTime;
    ...
    public EntityFallingBlock(World worldIn, double x, double y, double z, IWrapperBlockState fallingBlockState) {
        super(worldIn);
        ...
        if (this.fallTile.getMaterial() == Material.AIR) {
            ...
            if (!this.world.isRemote) {
                ...
                if (!this.onGround && !flag1) {
                    ...
                    IWrapperBlockState iblockstate = this.world.getBlockState(blockpos1);
    ...
    @Nullable
    public IWrapperBlockState getBlock() {
