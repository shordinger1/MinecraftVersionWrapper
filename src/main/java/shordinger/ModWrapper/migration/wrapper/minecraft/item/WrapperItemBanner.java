...
public class WrapperItemBanner extends WrapperItemBlock {

    public WrapperItemBanner() {
    ...
    public static void appendHoverTextFromTileEntityTag(TempItemStack stack, List<String> p_185054_1_) {
    ...
    public static TempItemStack makeBanner(EnumDyeColor color, @Nullable NBTTagList patterns) {
        TempItemStack itemstack = new TempItemStack(Items.BANNER, 1, color.getDyeDamage());
    ...
    public static EnumDyeColor getBaseColor(TempItemStack stack) {
