...
public class BlockFluidRenderer {
    ...
    public boolean renderFluid(IBlockAccess blockAccess, IWrapperBlockState blockStateIn, BlockPos blockPosIn,
        ...
        if (!flag1 && !flag2 && !aboolean[0] && !aboolean[1] && !aboolean[2] && !aboolean[3]) {
            ...
            for (int i1 = 0; i1 < 4; ++i1) {
                ...
                if (!flag) {
                    IWrapperBlockState state = blockAccess.getBlockState(blockpos);
    ...
    private float getFluidHeight(IBlockAccess blockAccess, BlockPos blockPosIn, Material blockMaterial) {
        ...
        for (int j = 0; j < 4; ++j) {
            ...
            IWrapperBlockState iblockstate = blockAccess.getBlockState(blockpos);
