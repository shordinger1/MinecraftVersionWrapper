...
public class BiomeMesa extends Biome {
    ...
    protected static final IWrapperBlockState COARSE_DIRT = Blocks.DIRT.getDefaultState()
        .withProperty(BlockDirt.VARIANT, BlockDirt.DirtType.COARSE_DIRT);
    protected static final IWrapperBlockState GRASS = Blocks.GRASS.getDefaultState();
    protected static final IWrapperBlockState HARDENED_CLAY = Blocks.HARDENED_CLAY.getDefaultState();
    protected static final IWrapperBlockState STAINED_HARDENED_CLAY = Blocks.STAINED_HARDENED_CLAY.getDefaultState();
    protected static final IWrapperBlockState ORANGE_STAINED_HARDENED_CLAY = STAINED_HARDENED_CLAY
        .withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE);
    protected static final IWrapperBlockState RED_SAND = Blocks.SAND.getDefaultState()
        .withProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND);
    private IWrapperBlockState[] clayBands;
    ...
    public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z, double noiseVal) {
        ...
        IWrapperBlockState iblockstate = STAINED_HARDENED_CLAY;
        IWrapperBlockState iblockstate3 = this.fillerBlock;
        ...
        for (int j1 = 255; j1 >= 0; --j1) {
            ...
            if (j1 <= rand.nextInt(5)) {
                ...
                IWrapperBlockState iblockstate1 = chunkPrimerIn.getBlockState(l1, j1, k1);
                    ...
                    if (l == -1) {
                        ...
                        if (j1 >= i2 - 1) {
                            if (this.hasForest && j1 > 86 + k * 2) {
                                ...
                                IWrapperBlockState iblockstate2;
    ...
    public void generateBands(long p_150619_1_) {
        this.clayBands = new IWrapperBlockState[64];
    ...
    public IWrapperBlockState getBand(int p_180629_1_, int p_180629_2_, int p_180629_3_) {
