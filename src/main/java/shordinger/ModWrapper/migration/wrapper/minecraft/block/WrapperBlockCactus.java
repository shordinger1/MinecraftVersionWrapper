...
public class WrapperBlockCactus extends WrapperBlock implements net.minecraftforge.common.IPlantable {
            ...
            if (i < 3) {
                ...
                if (net.minecraftforge.common.ForgeHooks.onCropsGrowPre(worldIn, blockpos, state, true)) {
                    if (j == 15) {
                        ...
                        IWrapperBlockState iblockstate = state.withProperty(AGE, Integer.valueOf(0));
