package shordinger.ModWrapper.migration.wrapper.minecraft.world.gen;
...
public class MapGenCaves extends MapGenBase {
    ...
    protected static final IWrapperBlockState BLK_LAVA = Blocks.LAVA.getDefaultState();
    protected static final IWrapperBlockState BLK_AIR = Blocks.AIR.getDefaultState();
    protected static final IWrapperBlockState BLK_SANDSTONE = Blocks.SANDSTONE.getDefaultState();
    protected static final IWrapperBlockState BLK_RED_SANDSTONE = Blocks.RED_SANDSTONE.getDefaultState();
                                ...
                                if (d10 * d10 + d8 * d8 < 1.0D) {
                                    for (int j2 = l; j2 > l2; --j2) {
                                        ...
                                        if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D) {
                                            IWrapperBlockState iblockstate1 = p_180702_5_.getBlockState(j3, j2, i2);
                                            IWrapperBlockState iblockstate2 = (IWrapperBlockState) MoreObjects
    ...
    protected boolean canReplaceBlock(IWrapperBlockState p_175793_1_, IWrapperBlockState p_175793_2_) {
    ...
    private boolean isTopBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ) {
        ...
        IWrapperBlockState state = data.getBlockState(x, y, z);
    ...
    protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop,
        IWrapperBlockState state, IWrapperBlockState up) {
        net.minecraft.world.biome.Biome biome = world.getBiome(new BlockPos(x + chunkX * 16, 0, z + chunkZ * 16));
        IWrapperBlockState top = biome.topBlock;
        IWrapperBlockState filler = biome.fillerBlock;
