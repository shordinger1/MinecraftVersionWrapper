...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable {
    ...
    public void processUpdateSign(CPacketUpdateSign packetIn) {
        ...
        if (worldserver.isBlockLoaded(blockpos)) {
            IWrapperBlockState iblockstate = worldserver.getBlockState(blockpos);
        ...
        if ("MC|BEdit".equals(s)) {
            ...
            try {
                ...
                if (commandblockbaselogic != null) {
                    ...
                    switch (tileentitycommandblock$mode) {
                        case SEQUENCE:
                            IWrapperBlockState iblockstate3 = Blocks.CHAIN_COMMAND_BLOCK.getDefaultState();
                            ...
                            break;
                        case AUTO:
                            IWrapperBlockState iblockstate2 = Blocks.REPEATING_COMMAND_BLOCK.getDefaultState();
                            this.player.world.setBlockState(
                                blockpos1,
                            ...
                            break;
                        case REDSTONE:
                            IWrapperBlockState iblockstate = Blocks.COMMAND_BLOCK.getDefaultState();
                            this.player.world.setBlockState(
                                blockpos1,
            ...
            try {
                BlockPos blockpos = new BlockPos(
                    ...
                    packetbuffer5.readInt(),
                    packetbuffer5.readInt());
                IWrapperBlockState iblockstate1 = this.player.world.getBlockState(blockpos);
