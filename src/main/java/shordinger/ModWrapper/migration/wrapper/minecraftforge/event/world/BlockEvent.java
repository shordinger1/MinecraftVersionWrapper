...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.event.world;
...
public class BlockEvent extends Event {
    ...
    private final IWrapperBlockState state;

    public BlockEvent(World world, BlockPos pos, IWrapperBlockState state) {
        this.pos = pos;
        this.world = world;
        this.state = state;
    }
    ...
    public IWrapperBlockState getState() {
        return state;
    }
    ...
    public static class HarvestDropsEvent extends BlockEvent {
        ...
        public HarvestDropsEvent(World world, BlockPos pos, IWrapperBlockState state, int fortuneLevel,
            float dropChance, List<ItemStack> drops, EntityPlayer harvester, boolean isSilkTouching) {
    ...
    public static class BreakEvent extends BlockEvent {
        ...
        public BreakEvent(World world, BlockPos pos, IWrapperBlockState state, EntityPlayer player) {
            super(world, pos, state);
            this.player = player;
    ...
    public static class EntityPlaceEvent extends BlockEvent {
        ...
        private final IWrapperBlockState placedBlock;
        private final IWrapperBlockState placedAgainst;

        public EntityPlaceEvent(@Nonnull BlockSnapshot blockSnapshot, @Nonnull IWrapperBlockState placedAgainst,
        ...
        public IWrapperBlockState getPlacedBlock() {
            return placedBlock;
        }

        public IWrapperBlockState getPlacedAgainst() {
    ...
    public static class PlaceEvent extends EntityPlaceEvent {
        ...
        public PlaceEvent(@Nonnull BlockSnapshot blockSnapshot, @Nonnull IWrapperBlockState placedAgainst,
    ...
    public static class EntityMultiPlaceEvent extends EntityPlaceEvent {
        ...
        public EntityMultiPlaceEvent(@Nonnull List<BlockSnapshot> blockSnapshots,
            @Nonnull IWrapperBlockState placedAgainst, @Nullable Entity entity) {
    ...
    public static class MultiPlaceEvent extends PlaceEvent {
        ...
        public MultiPlaceEvent(@Nonnull List<BlockSnapshot> blockSnapshots, @Nonnull IWrapperBlockState placedAgainst,
            @Nonnull EntityPlayer player, @Nonnull EnumHand hand) {
    ...
    public static class NeighborNotifyEvent extends BlockEvent {
        ...
        public NeighborNotifyEvent(World world, BlockPos pos, IWrapperBlockState state,
    ...
    public static class CreateFluidSourceEvent extends BlockEvent {
        ...
        public CreateFluidSourceEvent(World world, BlockPos pos, IWrapperBlockState state) {
            super(world, pos, state);
        }
    }

    /**
     * Fired when a liquid places a block. Use {@link #setNewState(IWrapperBlockState)} to change the result of
    ...
    public static class FluidPlaceBlockEvent extends BlockEvent {
        ...
        private IWrapperBlockState newState;
        private IWrapperBlockState origState;

        public FluidPlaceBlockEvent(World world, BlockPos pos, BlockPos liquidPos, IWrapperBlockState state) {
            super(world, pos, state);
         ...
         */
        public IWrapperBlockState getNewState() {
            return newState;
        }

        public void setNewState(IWrapperBlockState state) {
            this.newState = state;
        }
         ...
         */
        public IWrapperBlockState getOriginalState() {
            return origState;
        }
    }
    ...
    public static class CropGrowEvent extends BlockEvent {
        ...
        public CropGrowEvent(World world, BlockPos pos, IWrapperBlockState state) {
            super(world, pos, state);
        }
        ...
        public static class Pre extends CropGrowEvent {
            ...
            public Pre(World world, BlockPos pos, IWrapperBlockState state) {
                super(world, pos, state);
            }
        }
        ...
        public static class Post extends CropGrowEvent {
            ...
            private final IWrapperBlockState originalState;

            public Post(World world, BlockPos pos, IWrapperBlockState original, IWrapperBlockState state) {
                super(world, pos, state);
    ...
    public static class FarmlandTrampleEvent extends BlockEvent {
        ...
        public FarmlandTrampleEvent(World world, BlockPos pos, IWrapperBlockState state, float fallDistance,
            Entity entity) {
            super(world, pos, state);
            this.entity = entity;
    ...
    public static class PortalSpawnEvent extends BlockEvent {
        ...
        public PortalSpawnEvent(World world, BlockPos pos, IWrapperBlockState state, BlockPortal.Size size) {
            super(world, pos, state);
            this.size = size;
        }
