...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.common.property;
...
public class ExtendedBlockState extends BlockStateContainer {
    ...
    protected static class ExtendedStateImplementation extends StateImplementation
        ...
        protected ExtendedStateImplementation(Block block, ImmutableMap<IProperty<?>, Comparable<?>> properties,
            ...
            @Nullable ImmutableTable<IProperty<?>, Comparable<?>, IWrapperBlockState> table, IWrapperBlockState clean) {
        ...
        @Override
        @Nonnull
        public <T extends Comparable<T>, V extends T> IWrapperBlockState withProperty(@Nonnull IProperty<T> property,
            @Nonnull V value) {
            IWrapperBlockState clean = super.withProperty(property, value);
        ...
        @Override
        public IWrapperBlockState getClean() {
            return cleanState;
        }
    }
}
