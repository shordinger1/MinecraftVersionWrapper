...
public class RegistryBuilder<T extends IForgeRegistryEntry<T>> {
    ...
    private ClearCallback<T> getClear() {
        ...
        return (owner, stage) -> { for (ClearCallback<T> cb : this.clearCallback) cb.onClear(owner, stage); };
    }
    ...
    private CreateCallback<T> getCreate() {
        ...
        return (owner, stage) -> { for (CreateCallback<T> cb : this.createCallback) cb.onCreate(owner, stage); };
    }
