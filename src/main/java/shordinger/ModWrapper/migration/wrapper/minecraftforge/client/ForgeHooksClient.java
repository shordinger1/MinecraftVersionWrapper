...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.client;
...
public class ForgeHooksClient {
    ...
    public static void orientBedCamera(IBlockAccess world, BlockPos pos, IWrapperBlockState state, Entity entity) {
    ...
    public static float getFOVModifier(EntityRenderer renderer, Entity entity, IWrapperBlockState state,
    ...
    public static float getFogDensity(EntityRenderer renderer, Entity entity, IWrapperBlockState state, float partial,
        float density) {
    ...
    public static void onFogRender(EntityRenderer renderer, Entity entity, IWrapperBlockState state, float partial,
        int mode, float distance) {
    ...
    public static IBakedModel getDamageModel(IBakedModel ibakedmodel, TextureAtlasSprite texture,
        IWrapperBlockState state, IBlockAccess world, BlockPos pos) {
