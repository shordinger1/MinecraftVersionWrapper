...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.server.permission.context;
...
public class BlockPosContext extends PlayerContext {
    ...
    private IWrapperBlockState blockState;
    private EnumFacing facing;

    public BlockPosContext(EntityPlayer ep, BlockPos pos, @Nullable IWrapperBlockState state, @Nullable EnumFacing f) {
        super(ep);
