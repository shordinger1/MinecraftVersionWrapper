...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.fml.client;
...
public abstract class CustomModLoadingErrorDisplayException extends EnhancedRuntimeException
    ...
    @Override
    public void printStackTrace(EnhancedRuntimeException.WrappedPrintStream s) {}; // Do Nothing unless the modder wants
                                                                                   // to.
