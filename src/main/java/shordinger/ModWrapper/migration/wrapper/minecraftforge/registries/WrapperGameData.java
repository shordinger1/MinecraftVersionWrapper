...
// */
//
package shordinger.ModWrapper.migration.wrapper.minecraftforge.registries;
...
//
//    @SuppressWarnings("unchecked")
//    public static ObjectIntIdentityMap<IWrapperBlockState> getBlockStateIDMap() {
...
//        for (Map.Entry<ResourceLocation, ForgeRegistry<? extends IForgeRegistryEntry<?>>> r : WrapperRegistryManager.ACTIVE.registries
//            .entrySet()) {
//            final Class<? extends IForgeRegistryEntry> clazz = WrapperRegistryManager.ACTIVE.getSuperType(r.getKey());
//            loadRegistry(r.getKey(), WrapperRegistryManager.ACTIVE, WrapperRegistryManager.VANILLA, clazz, true);
//        }
//        WrapperRegistryManager.VANILLA.registries.forEach((name, reg) -> {
//            reg.validateContent(name);
//            reg.freeze();
//        });
//        WrapperRegistryManager.VANILLA.registries.forEach(LOCK_VANILLA);
//        WrapperRegistryManager.ACTIVE.registries.forEach(LOCK_VANILLA);
...
//            .entrySet()) {
//            final Class<? extends IForgeRegistryEntry> clazz = WrapperRegistryManager.ACTIVE.getSuperType(r.getKey());
//            loadRegistry(r.getKey(), WrapperRegistryManager.ACTIVE, WrapperRegistryManager.FROZEN, clazz, true);
//        }
//        WrapperRegistryManager.FROZEN.registries.forEach((name, reg) -> {
//            reg.validateContent(name);
//            reg.freeze();
//        });
//        WrapperRegistryManager.ACTIVE.registries.forEach((name, reg) -> reg.freeze());
//
...
//        if (WrapperRegistryManager.FROZEN.registries.isEmpty()) {
//            FMLLog.log.warn("Can't revert to frozen GameData state without freezing first.");
//            return;
//        }
//        WrapperRegistryManager.ACTIVE.registries.forEach((name, reg) -> reg.resetDelegates());
//
//        FMLLog.log.debug("Reverting to frozen data state.");
//        for (Map.Entry<ResourceLocation, ForgeRegistry<? extends IForgeRegistryEntry<?>>> r : WrapperRegistryManager.ACTIVE.registries
//            .entrySet()) {
//            final Class<? extends IForgeRegistryEntry> clazz = WrapperRegistryManager.ACTIVE.getSuperType(r.getKey());
//            loadRegistry(r.getKey(), WrapperRegistryManager.FROZEN, WrapperRegistryManager.ACTIVE, clazz, true);
//        }
...
//
//    @SuppressWarnings({ "rawtypes", "unchecked" })
//    public static void revert(WrapperRegistryManager state, ResourceLocation registry, boolean lock) {
//        FMLLog.log.debug("Reverting {} to {}", registry, state.getName());
//        final Class<? extends IForgeRegistryEntry> clazz = WrapperRegistryManager.ACTIVE.getSuperType(registry);
//        loadRegistry(registry, state, WrapperRegistryManager.ACTIVE, clazz, lock);
...
//        @Override
//        public void onAdd(IForgeRegistryInternal<Block> owner, WrapperRegistryManager stage, int id, Block block,
//                          @Nullable Block oldBlock) {
//            @SuppressWarnings("unchecked")
//            ClearableObjectIntIdentityMap<IWrapperBlockState> blockstateMap = owner
//                .getSlaveMap(BLOCKSTATE_TO_ID, ClearableObjectIntIdentityMap.class);
//
//            if (oldBlock != null) {
//                for (IWrapperBlockState state : oldBlock.getBlockState()
//                    .getValidStates()) {
...
//            for (IWrapperBlockState state : block.getBlockState()
//                .getValidStates()) {
...
//
//        @Override
//        public void onClear(IForgeRegistryInternal<Block> owner, WrapperRegistryManager stage) {
//            owner.getSlaveMap(BLOCKSTATE_TO_ID, ClearableObjectIntIdentityMap.class)
//                .clear();
//        }
//
//        @Override
//        public void onCreate(IForgeRegistryInternal<Block> owner, WrapperRegistryManager stage) {
//            final ClearableObjectIntIdentityMap<IWrapperBlockState> idMap = new ClearableObjectIntIdentityMap<IWrapperBlockState>() {
//
//                @SuppressWarnings("deprecation")
//                @Override
//                public int get(IWrapperBlockState key) {
...
//            WrapperGameData.forceRegistryName(ret, key);
//            return ret;
//        }
//
...
//
//        @Override
//        public void onAdd(IForgeRegistryInternal<Item> owner, WrapperRegistryManager stage, int id, Item item,
...
//
//        @Override
//        public void onClear(IForgeRegistryInternal<Item> owner, WrapperRegistryManager stage) {
//            owner.getSlaveMap(BLOCK_TO_ITEM, BiMap.class)
//                .clear();
//        }
//
//        @Override
//        public void onCreate(IForgeRegistryInternal<Item> owner, WrapperRegistryManager stage) {
...
//
//        @Override
//        public void onValidate(IForgeRegistryInternal<IRecipe> owner, WrapperRegistryManager stage, int id,
//                               ResourceLocation key, IRecipe obj) {
//            if (stage != WrapperRegistryManager.ACTIVE) return;
...
//
//        @Override
//        public void onAdd(IForgeRegistryInternal<EntityEntry> owner, WrapperRegistryManager stage, int id, EntityEntry entry,
...
//
//        @Override
//        public void onClear(IForgeRegistryInternal<EntityEntry> owner, WrapperRegistryManager stage) {
//            owner.getSlaveMap(ENTITY_CLASS_TO_ENTRY, Map.class)
//                .clear();
//        }
//
//        @Override
//        public void onCreate(IForgeRegistryInternal<EntityEntry> owner, WrapperRegistryManager stage) {
...
//
//        @Override
//        public void onAdd(IForgeRegistryInternal<DataSerializerEntry> owner, WrapperRegistryManager stage, int id,
...
//
//        @Override
//        public void onClear(IForgeRegistryInternal<DataSerializerEntry> owner, WrapperRegistryManager stage) {
//            owner.getSlaveMap(SERIALIZER_TO_ENTRY, Map.class)
//                .clear();
//        }
//
//        @Override
//        public void onCreate(IForgeRegistryInternal<DataSerializerEntry> owner, WrapperRegistryManager stage) {
...
//                                                                        final WrapperRegistryManager from, final WrapperRegistryManager to, final Class<T> regType, boolean freeze) {
...
//        WrapperRegistryManager.ACTIVE.registries.forEach((name, reg) -> reg.validateContent(name));
//        WrapperRegistryManager.ACTIVE.registries.forEach((name, reg) -> reg.dump(name));
//        WrapperRegistryManager.ACTIVE.registries.forEach((name, reg) -> reg.resetDelegates());
//
//        if (isLocalWorld) {
//            List<ResourceLocation> missingRegs = snapshot.keySet()
//                .stream()
//                .filter(name -> !WrapperRegistryManager.ACTIVE.registries.containsKey(name))
...
//        }
//
//        WrapperRegistryManager STAGING = new WrapperRegistryManager("STAGING");
//
...
//            final Class<? extends IForgeRegistryEntry> clazz = WrapperRegistryManager.ACTIVE.getSuperType(key);
//            remaps.put(key, Maps.newLinkedHashMap());
//            missing.put(key, Maps.newHashMap());
//            loadPersistentDataToStagingRegistry(
//                WrapperRegistryManager.ACTIVE,
//                STAGING,
//                remaps.get(key),
//                missing.get(key),
//                key,
...
//
//                    final Class<? extends IForgeRegistryEntry> clazz = WrapperRegistryManager.ACTIVE.getSuperType(name);
//                    processMissing(
//                        clazz,
//                        name,
//                        STAGING,
...
//            WrapperRegistryManager.ACTIVE.registries.forEach((name, reg) -> {
//                final Class<? extends IForgeRegistryEntry> clazz = WrapperRegistryManager.ACTIVE.getSuperType(name);
...
//        for (Map.Entry<ResourceLocation, ForgeRegistry<? extends IForgeRegistryEntry<?>>> r : WrapperRegistryManager.ACTIVE.registries
//            .entrySet()) {
//            final Class<? extends IForgeRegistryEntry> registrySuperType = WrapperRegistryManager.ACTIVE
//                .getSuperType(r.getKey());
//            loadRegistry(r.getKey(), STAGING, WrapperRegistryManager.ACTIVE, registrySuperType, true);
//        }
//
...
//    private static <T extends IForgeRegistryEntry<T>> void loadPersistentDataToStagingRegistry(WrapperRegistryManager pool,
//                                                                                               WrapperRegistryManager to, Map<ResourceLocation, Integer[]> remaps, Map<ResourceLocation, Integer> missing,
...
//        ForgeRegistry<T> _new = to.getRegistry(name, WrapperRegistryManager.ACTIVE);
...
//                                                                          WrapperRegistryManager STAGING, MissingMappings<?> e, Map<ResourceLocation, Integer> missing,
...
//        ForgeRegistry<T> active = WrapperRegistryManager.ACTIVE.getRegistry(name);
...
//    }
//
//    private static <T extends IForgeRegistryEntry<T>> void loadFrozenDataToStagingRegistry(WrapperRegistryManager STAGING,
//                                                                                           ResourceLocation name, Map<ResourceLocation, Integer[]> remaps, Class<T> clazz) {
//        ForgeRegistry<T> frozen = WrapperRegistryManager.FROZEN.getRegistry(name);
//        ForgeRegistry<T> newRegistry = STAGING.getRegistry(name, WrapperRegistryManager.FROZEN);
...
//        List<ResourceLocation> keys = Lists.newArrayList(WrapperRegistryManager.ACTIVE.registries.keySet());
//        Collections.sort(
//            keys,
//            (o1, o2) -> o1.toString()
...
//            MinecraftForge.EVENT_BUS.post(
//                WrapperRegistryManager.ACTIVE.getRegistry(rl)
//                    .getRegisterEvent(rl));
//        }
