...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.event;
...
public class ForgeEventFactory {
    ...
    public static EntityMultiPlaceEvent onMultiBlockPlace(@Nullable Entity entity, List<BlockSnapshot> blockSnapshots,
        ...
        IWrapperBlockState placedAgainst = snap.getWorld()
            .getBlockState(
                snap.getPos()
    ...
    public static EntityPlaceEvent onBlockPlace(@Nullable Entity entity, @Nonnull BlockSnapshot blockSnapshot,
        ...
        IWrapperBlockState placedAgainst = blockSnapshot.getWorld()
            .getBlockState(
    ...
    public static NeighborNotifyEvent onNeighborNotify(World world, BlockPos pos, IWrapperBlockState state,
    ...
    public static boolean doPlayerHarvestCheck(EntityPlayer player, IWrapperBlockState state, boolean success) {
        PlayerEvent.HarvestCheck event = new PlayerEvent.HarvestCheck(player, state, success);
        MinecraftForge.EVENT_BUS.post(event);
        return event.canHarvest();
    }

    public static float getBreakSpeed(EntityPlayer player, IWrapperBlockState state, float original, BlockPos pos) {
    ...
    public static float fireBlockHarvesting(List<ItemStack> drops, World world, BlockPos pos, IWrapperBlockState state,
    ...
    public static IWrapperBlockState fireFluidPlaceBlockEvent(World world, BlockPos pos, BlockPos liquidPos,
    ...
    public static int onApplyBonemeal(@Nonnull EntityPlayer player, @Nonnull World world, @Nonnull BlockPos pos,
        @Nonnull IWrapperBlockState state, @Nonnull ItemStack stack, @Nullable EnumHand hand) {
    ...
    public static boolean onPotionAttemptBrew(NonNullList<ItemStack> stacks) {
        ...
        for (int x = 0; x < tmp.size(); x++) tmp.set(
            x,
            stacks.get(x)
                .copy());
    ...
    public static boolean renderBlockOverlay(EntityPlayer player, float renderPartialTicks, OverlayType type,
        IWrapperBlockState block, BlockPos pos) {
    ...
    public static boolean fireSleepingLocationCheck(EntityPlayer player, BlockPos sleepingLocation) {
        ...
        if (canContinueSleep == Result.DEFAULT) {
            IWrapperBlockState state = player.world.getBlockState(player.bedLocation);
    ...
    public static boolean canCreateFluidSource(World world, BlockPos pos, IWrapperBlockState state, boolean def) {
    ...
    public static boolean onEntityDestroyBlock(EntityLivingBase entity, BlockPos pos, IWrapperBlockState state) {
