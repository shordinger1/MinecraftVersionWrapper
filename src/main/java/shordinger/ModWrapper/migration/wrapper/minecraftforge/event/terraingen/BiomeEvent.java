...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.event.terraingen;
...
public class BiomeEvent extends Event {
    ...
    public static class GetVillageBlockID extends BiomeEvent {
        ...
        private final IWrapperBlockState original;
        private IWrapperBlockState replacement;

        public GetVillageBlockID(Biome biome, IWrapperBlockState original) {
            super(biome);
            this.original = original;
        }

        public IWrapperBlockState getOriginal() {
            return original;
        }

        public IWrapperBlockState getReplacement() {
            return replacement;
        }

        public void setReplacement(IWrapperBlockState replacement) {
