...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.client.model.pipeline;
...
public class ForgeBlockModelRenderer extends BlockModelRenderer {
    ...
    @Override
    public boolean renderModelFlat(IBlockAccess world, IBakedModel model, IWrapperBlockState state, BlockPos pos,
    ...
    @Override
    public boolean renderModelSmooth(IBlockAccess world, IBakedModel model, IWrapperBlockState state, BlockPos pos,
        BufferBuilder buffer, boolean checkSides, long rand) {
        if (ForgeModContainer.forgeLightPipelineEnabled) {
    ...
    public static boolean render(VertexLighterFlat lighter, IBlockAccess world, IBakedModel model,
        IWrapperBlockState state, BlockPos pos, BufferBuilder wr, boolean checkSides, long rand) {
