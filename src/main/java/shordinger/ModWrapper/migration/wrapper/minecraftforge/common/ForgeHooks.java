...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.common;
...
public class ForgeHooks {
    ...
    public static float blockStrength(@Nonnull IWrapperBlockState state, @Nonnull EntityPlayer player,
    ...
    public static boolean onPickBlock(RayTraceResult target, EntityPlayer player, World world) {
        ...
        if (target.typeOfHit == RayTraceResult.Type.BLOCK) {
            IWrapperBlockState state = world.getBlockState(target.getBlockPos());
    ...
    public static boolean isLivingOnLadder(@Nonnull IWrapperBlockState state, @Nonnull World world,
        ...
        if (ret == EnumActionResult.SUCCESS) {
            ...
            if (placeEvent != null && placeEvent.isCanceled()) {
                ...
                for (BlockSnapshot snap : blockSnapshots) {
                    ...
                    IWrapperBlockState oldBlock = snap.getReplacedBlock();
                    IWrapperBlockState newBlock = world.getBlockState(snap.getPos());
    ...
    public static boolean isInsideOfMaterial(Material material, Entity entity, BlockPos pos) {
        IWrapperBlockState state = entity.world.getBlockState(pos);
    ...
    public static boolean onCropsGrowPre(World worldIn, BlockPos pos, IWrapperBlockState state, boolean def) {
    ...
    public static void onCropsGrowPost(World worldIn, BlockPos pos, IWrapperBlockState state,
        IWrapperBlockState blockState) {
    ...
    public static boolean onFarmlandTrample(World world, BlockPos pos, IWrapperBlockState state, float fallDistance,
        Entity entity) {
