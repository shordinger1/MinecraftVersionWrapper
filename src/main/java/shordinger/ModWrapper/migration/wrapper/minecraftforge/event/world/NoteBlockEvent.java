...
public class NoteBlockEvent extends BlockEvent {
    ...
    protected NoteBlockEvent(World world, BlockPos pos, IWrapperBlockState state, int note) {
    ...
    public static class Play extends NoteBlockEvent {
        ...
        public Play(World world, BlockPos pos, IWrapperBlockState state, int note, int instrument) {
    ...
    public static class Change extends NoteBlockEvent {
        ...
        public Change(World world, BlockPos pos, IWrapperBlockState state, int oldNote, int newNote) {
