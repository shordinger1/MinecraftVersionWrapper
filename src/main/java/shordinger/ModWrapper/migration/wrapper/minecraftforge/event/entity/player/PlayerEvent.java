...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.event.entity.player;
...
public class PlayerEvent extends LivingEvent {
     ...
     * {@link EntityPlayer#canHarvestBlock(IWrapperBlockState)}.<br>
     * <br>
     * This event is fired via the
     * {@link ForgeEventFactory#doPlayerHarvestCheck(EntityPlayer, IWrapperBlockState, boolean)}.<br>
     * <br>
     * {@link #state} contains the {@link IWrapperBlockState} that is being checked for harvesting. <br>
    ...
    public static class HarvestCheck extends PlayerEvent {
        ...
        public HarvestCheck(EntityPlayer player, IWrapperBlockState state, boolean success) {
            super(player);
            this.state = state;
            this.success = success;
        }

        public IWrapperBlockState getTargetBlock() {
            return this.state;
        }
     ...
     * <br>
     * This event is fired via the
     * {@link ForgeEventFactory#getBreakSpeed(EntityPlayer, IWrapperBlockState, float, BlockPos)}.<br>
     * <br>
    ...
    public static class BreakSpeed extends PlayerEvent {
        ...
        public BreakSpeed(EntityPlayer player, IWrapperBlockState state, float original, BlockPos pos) {
            super(player);
            this.state = state;
