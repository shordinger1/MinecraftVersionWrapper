...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.fluids;
...
public abstract class BlockFluidBase extends Block implements IFluidBlock {
     ...
     */
    @Override
    public int getMetaFromState(@Nonnull IWrapperBlockState state) {
    ...
    @Override
    public abstract boolean canCollideCheck(@Nonnull IWrapperBlockState state, boolean fullHit);
     ...
     */
    @Override
    public void onBlockAdded(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IWrapperBlockState state) {
     ...
     */
    @Override
    public void neighborChanged(@Nonnull IWrapperBlockState state, @Nonnull World world, @Nonnull BlockPos pos,
    ...
    @Override
    @Nonnull
    public Item getItemDropped(@Nonnull IWrapperBlockState state, @Nonnull Random rand, int fortune) {
        return Items.AIR;
    }
    ...
    @Override
    public int getLightValue(@Nonnull IWrapperBlockState state, @Nonnull IBlockAccess world, @Nonnull BlockPos pos) {
        if (maxScaledLight == 0) {
     ...
     */
    @Override
    public boolean isOpaqueCube(@Nonnull IWrapperBlockState state) {
        return false;
    }

    @Override
    public boolean isFullCube(@Nonnull IWrapperBlockState state) {
        return false;
    }

    @Override
    public int getPackedLightmapCoords(@Nonnull IWrapperBlockState state, @Nonnull IBlockAccess world,
    ...
    @Override
    @Nonnull
    public BlockFaceShape getBlockFaceShape(@Nonnull IBlockAccess worldIn, @Nonnull IWrapperBlockState state,
        @Nonnull BlockPos pos, @Nonnull EnumFacing face) {
        return BlockFaceShape.UNDEFINED;
    }

    @Override
    public boolean shouldSideBeRendered(@Nonnull IWrapperBlockState state, @Nonnull IBlockAccess world,
        @Nonnull BlockPos pos, @Nonnull EnumFacing side) {
        IWrapperBlockState neighbor = world.getBlockState(pos.offset(side));
    ...
    private static boolean isFluid(@Nonnull IWrapperBlockState blockstate) {
    ...
    @Override
    @Nonnull
    public IWrapperBlockState getExtendedState(@Nonnull IWrapperBlockState oldState, @Nonnull IBlockAccess world,
        @Nonnull BlockPos pos) {
        IExtendedBlockState state = (IExtendedBlockState) oldState;
        state = state.withProperty(FLOW_DIRECTION, (float) getFlowDirection(world, pos));
        IWrapperBlockState[][] upBlockState = new IWrapperBlockState[3][3];
    ...
    @Nullable
    private static Fluid getFluid(IWrapperBlockState state) {
        Block block = state.getBlock();
    ...
    public float getFluidHeightForRender(IBlockAccess world, BlockPos pos, @Nonnull IWrapperBlockState up) {
        IWrapperBlockState here = world.getBlockState(pos);
    ...
    @Override
    public AxisAlignedBB getCollisionBoundingBox(@Nonnull IWrapperBlockState blockState, @Nonnull IBlockAccess worldIn,
        @Nonnull BlockPos pos) {
        return NULL_AABB;
    }
    ...
    public Vec3d getFogColor(World world, BlockPos pos, IWrapperBlockState state, Entity entity, Vec3d originalColor,
        ...
        if (!isWithinFluid(world, pos, ActiveRenderInfo.projectViewFromEntity(entity, partialTicks))) {
            ...
            IWrapperBlockState otherState = world.getBlockState(otherPos);
    ...
    @Override
    public IWrapperBlockState getStateAtViewpoint(IWrapperBlockState state, IBlockAccess world, BlockPos pos,
        Vec3d viewpoint) {
