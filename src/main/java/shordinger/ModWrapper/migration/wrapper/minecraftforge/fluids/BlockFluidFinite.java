...
public class BlockFluidFinite extends BlockFluidBase {
    ...
    @Override
    public boolean canCollideCheck(@Nonnull IWrapperBlockState state, boolean fullHit) {
        return fullHit;
    }
    ...
    @Override
    public void updateTick(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IWrapperBlockState state,
        @Nonnull Random rand) {
    ...
    public int tryToFlowVerticallyInto(World world, BlockPos pos, int amtToInput) {
        IWrapperBlockState myState = world.getBlockState(pos);
    ...
    public int place(World world, BlockPos pos, @Nonnull FluidStack fluidStack, boolean doPlace) {
        IWrapperBlockState existing = world.getBlockState(pos);
