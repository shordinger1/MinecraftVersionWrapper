...
public class WrapperRegistryManager {

    public static final WrapperRegistryManager ACTIVE = new WrapperRegistryManager("ACTIVE");
    public static final WrapperRegistryManager VANILLA = new WrapperRegistryManager("VANILLA");
    public static final WrapperRegistryManager FROZEN = new WrapperRegistryManager("FROZEN");
    ...
    public WrapperRegistryManager(String name) {
        this.name = name;
    }
