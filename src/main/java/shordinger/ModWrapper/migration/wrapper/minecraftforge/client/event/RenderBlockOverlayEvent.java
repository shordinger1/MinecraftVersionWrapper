...
public class RenderBlockOverlayEvent extends Event {
    ...
    private final IWrapperBlockState blockForOverlay;
    ...
    public RenderBlockOverlayEvent(EntityPlayer player, float renderPartialTicks, OverlayType type,
        IWrapperBlockState block, BlockPos blockPos) {
        this.player = player;
     ...
     */
    public IWrapperBlockState getBlockForOverlay() {
