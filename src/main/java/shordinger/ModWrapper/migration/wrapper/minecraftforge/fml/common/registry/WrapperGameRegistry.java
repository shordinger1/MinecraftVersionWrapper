...
import shordinger.ModWrapper.migration.wrapper.minecraftforge.fml.common.IWrapperWorldGenerator;
import shordinger.ModWrapper.migration.wrapper.minecraftforge.registries.WrapperGameData;
import shordinger.ModWrapper.migration.wrapper.minecraftforge.registries.IForgeRegistryEntry;

public class WrapperGameRegistry extends GameRegistry {

    private static Set<IWrapperWorldGenerator> worldGenerators = Sets.newHashSet();
    private static Map<IWrapperWorldGenerator, Integer> worldGeneratorIndex = Maps.newHashMap();
    private static List<IFuelHandler> fuelHandlers = Lists.newArrayList();
    private static List<IWrapperWorldGenerator> sortedGeneratorList;
     ...
     */
    public static void registerWorldGenerator(IWrapperWorldGenerator generator, int modGenerationWeight) {
    ...
    public static void generateWorld(int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
        ...
        for (IWrapperWorldGenerator generator : sortedGeneratorList) {
    ...
    private static void computeSortedGeneratorList() {
        ArrayList<IWrapperWorldGenerator> list = Lists.newArrayList(worldGenerators);
    ...
    private static <K extends IForgeRegistryEntry<K>> K register(K object) {
        return (K) WrapperGameData.register_impl(object);
    }
    ...
    public static void registerTileEntity(Class<? extends TileEntity> tileEntityClass, String key) {
        ...
        WrapperGameData.checkPrefix(new ResourceLocation(key).toString(), true);
