...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.common.util;
...
public class BlockSnapshot {
    ...
    @Nullable
    private IWrapperBlockState replacedBlock;
    private int flag;
    @Nullable
    ...
    public BlockSnapshot(World world, BlockPos pos, IWrapperBlockState state) {
        this(world, pos, state, getTileNBT(world.getTileEntity(pos)));
    }

    public BlockSnapshot(World world, BlockPos pos, IWrapperBlockState state, @Nullable NBTTagCompound nbt) {
        this.setWorld(world);
    ...
    public BlockSnapshot(World world, BlockPos pos, IWrapperBlockState state, int flag) {
    ...
    public IWrapperBlockState getCurrentBlock() {
    ...
    public IWrapperBlockState getReplacedBlock() {
    ...
    public boolean restoreToLocation(World world, BlockPos pos, boolean force, boolean notifyNeighbors) {
        IWrapperBlockState current = getCurrentBlock();
        IWrapperBlockState replaced = getReplacedBlock();
    ...
    public void setReplacedBlock(IWrapperBlockState replacedBlock) {
