...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.fluids.capability.wrappers;
...
public class BlockLiquidWrapper implements IFluidHandler {
    ...
    public IFluidTankProperties[] getTankProperties() {
        ...
        IWrapperBlockState blockState = world.getBlockState(blockPos);
    ...
    @Nullable
    private FluidStack getStack(IWrapperBlockState blockState) {
