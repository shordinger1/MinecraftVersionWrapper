...
package shordinger.ModWrapper.migration.wrapper.minecraftforge.client.event;
...
public abstract class EntityViewRenderEvent extends Event {
    ...
    public EntityViewRenderEvent(EntityRenderer renderer, Entity entity, IWrapperBlockState state,
    ...
    public static class FogDensity extends EntityViewRenderEvent {
        ...
        public FogDensity(EntityRenderer renderer, Entity entity, IWrapperBlockState state, double renderPartialTicks,
            float density) {
    ...
    public static class RenderFogEvent extends EntityViewRenderEvent {
        ...
        public RenderFogEvent(EntityRenderer renderer, Entity entity, IWrapperBlockState state,
            double renderPartialTicks, int fogMode, float farPlaneDistance) {
            super(renderer, entity, state, renderPartialTicks);
    ...
    public static class FogColors extends EntityViewRenderEvent {
        ...
        public FogColors(EntityRenderer renderer, Entity entity, IWrapperBlockState state, double renderPartialTicks,
    ...
    public static class CameraSetup extends EntityViewRenderEvent {
        ...
        public CameraSetup(EntityRenderer renderer, Entity entity, IWrapperBlockState state, double renderPartialTicks,
    ...
    public static class FOVModifier extends EntityViewRenderEvent {
        ...
        public FOVModifier(EntityRenderer renderer, Entity entity, IWrapperBlockState state, double renderPartialTicks,
            float fov) {
            super(renderer, entity, state, renderPartialTicks);
            this.setFOV(fov);
        }
